...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(1978)
// --------------------------------------------------------------

// public enum Alignment :1978
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(2003)
// --------------------------------------------------------------

// public static class AlignmentHelpers :2003
// {
...
// public static float2 GetAnchor(Fuse.Elements.Alignment a) :2014
void AlignmentHelpers__GetAnchor_fn(int* a, ::g::Uno::Float2* __retval)
{
    *__retval = AlignmentHelpers::GetAnchor(*a);
}

// public static Fuse.Elements.Alignment GetHorizontalAlign(Fuse.Elements.Alignment a) :2009
void AlignmentHelpers__GetHorizontalAlign_fn(int* a, int* __retval)
{
    *__retval = AlignmentHelpers::GetHorizontalAlign(*a);
}

// internal static Fuse.Elements.SimpleAlignment GetHorizontalSimpleAlign(Fuse.Elements.Alignment a) :2037
...
// public static Fuse.Elements.Alignment GetVerticalAlign(Fuse.Elements.Alignment a) :2005
void AlignmentHelpers__GetVerticalAlign_fn(int* a, int* __retval)
{
    *__retval = AlignmentHelpers::GetVerticalAlign(*a);
}

// internal static Fuse.Elements.SimpleAlignment GetVerticalSimpleAlign(Fuse.Elements.Alignment a) :2027
void AlignmentHelpers__GetVerticalSimpleAlign_fn(int* a, int* __retval)
{
    *__retval = AlignmentHelpers::GetVerticalSimpleAlign(*a);
}

// public static float2 GetAnchor(Fuse.Elements.Alignment a) [static] :2014
...
// public static Fuse.Elements.Alignment GetHorizontalAlign(Fuse.Elements.Alignment a) [static] :2009
...
// internal static Fuse.Elements.SimpleAlignment GetHorizontalSimpleAlign(Fuse.Elements.Alignment a) [static] :2037
...
// public static Fuse.Elements.Alignment GetVerticalAlign(Fuse.Elements.Alignment a) [static] :2005
...
// internal static Fuse.Elements.SimpleAlignment GetVerticalSimpleAlign(Fuse.Elements.Alignment a) [static] :2027
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(1754)
// --------------------------------------------------------------

// private sealed class TransformOrigins.AnchorOrigin :1754
// {
...
// public generated AnchorOrigin() :1754
void TransformOrigins__AnchorOrigin__ctor__fn(TransformOrigins__AnchorOrigin* __this)
{
    __this->ctor_();
}

// public float3 GetOffset(Fuse.Elements.Element elm) :1756
...
// public generated AnchorOrigin New() :1754
...
// public generated AnchorOrigin() [instance] :1754
void TransformOrigins__AnchorOrigin::ctor_()
{
}

// public float3 GetOffset(Fuse.Elements.Element elm) [instance] :1756
...
// public generated AnchorOrigin New() [static] :1754
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(1759)
// --------------------------------------------------------------

// private sealed class TransformOrigins.BoxCenter :1759
// {
...
// public generated BoxCenter() :1759
void TransformOrigins__BoxCenter__ctor__fn(TransformOrigins__BoxCenter* __this)
{
    __this->ctor_();
}

// public float3 GetOffset(Fuse.Elements.Element elm) :1763
...
// public generated BoxCenter New() [static] :1759
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(108)
// -------------------------------------------------------------

// internal enum BoxFlags :108
uEnumType* BoxFlags_typeof()
{
    static uSStrong<uEnumType*> type;
    if (type != NULL) return type;

    type = uEnumType::New("Fuse.Elements.BoxFlags", ::g::Uno::Int_typeof(), 4);
    type->SetLiterals(
        "None", 0LL,
        "X", 1LL,
        "Y", 2LL,
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(96)
// ------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(116)
// -------------------------------------------------------------

// internal abstract class BoxSizing :116
// {
BoxSizing_type* BoxSizing_typeof()
{
    ...
    ::TYPES[4] = ::g::Fuse::Elements::BoxFlags_typeof();
    ::TYPES[0] = ::g::Uno::Int_typeof();
    ::TYPES[2] = ::g::Fuse::Elements::Element_typeof();
...
// protected generated BoxSizing() :116
void BoxSizing__ctor__fn(BoxSizing* __this)
{
    __this->ctor_();
}

// internal static Fuse.Elements.BoxFlags BoxFlagsOf(Fuse.LayoutParams lp) :118
void BoxSizing__BoxFlagsOf_fn(::g::Fuse::LayoutParams* lp, int* __retval)
{
    *__retval = BoxSizing::BoxFlagsOf(*lp);
}

// protected void EffectiveAnchor(Fuse.Elements.Element element, Fuse.Elements.SimpleAlignment halign, Fuse.Elements.SimpleAlignment valign, float2& anchor, Fuse.Elements.SizeUnit& unit) :211
...
// protected Fuse.Elements.SimpleAlignment EffectiveHorizontalAlignment(Fuse.Elements.Element element) :168
...
// protected Fuse.Elements.SimpleAlignment EffectiveVerticalAlignment(Fuse.Elements.Element element) :185
...
// protected Fuse.LayoutParams GetConstraints(Fuse.Elements.Element element, Fuse.LayoutParams lp, [Fuse.Elements.BoxSizing.ConstraintFlags flags]) :232
...
// public virtual Fuse.LayoutDependent IsContentRelativeSize(Fuse.Elements.Element element) :144
...
// public virtual void RequestLayout(Fuse.Elements.Element element) :142
void BoxSizing__RequestLayout_fn(BoxSizing* __this, ::g::Fuse::Elements::Element* element)
{
}

// protected float SimpleToAnchor(Fuse.Elements.SimpleAlignment align) :202
void BoxSizing__SimpleToAnchor_fn(BoxSizing* __this, int* align, float* __retval)
{
    *__retval = __this->SimpleToAnchor(*align);
}

// protected float UnitSize(Fuse.Elements.Element element, float scalar, Fuse.Elements.SizeUnit unit, float relative, bool hasRelative, bool& known) :150
...
// protected generated BoxSizing() [instance] :116
void BoxSizing::ctor_()
{
}

// protected void EffectiveAnchor(Fuse.Elements.Element element, Fuse.Elements.SimpleAlignment halign, Fuse.Elements.SimpleAlignment valign, float2& anchor, Fuse.Elements.SizeUnit& unit) [instance] :211
...
// protected Fuse.Elements.SimpleAlignment EffectiveHorizontalAlignment(Fuse.Elements.Element element) [instance] :168
...
// protected Fuse.Elements.SimpleAlignment EffectiveVerticalAlignment(Fuse.Elements.Element element) [instance] :185
...
// protected Fuse.LayoutParams GetConstraints(Fuse.Elements.Element element, Fuse.LayoutParams lp, [Fuse.Elements.BoxSizing.ConstraintFlags flags]) [instance] :232
...
// protected float SimpleToAnchor(Fuse.Elements.SimpleAlignment align) [instance] :202
...
// protected float UnitSize(Fuse.Elements.Element element, float scalar, Fuse.Elements.SizeUnit unit, float relative, bool hasRelative, bool& known) [instance] :150
...
// internal static Fuse.Elements.BoxFlags BoxFlagsOf(Fuse.LayoutParams lp) [static] :118
int BoxSizing::BoxFlagsOf(::g::Fuse::LayoutParams lp)
{
    uStackFrame __("Fuse.Elements.BoxSizing", "BoxFlagsOf(Fuse.LayoutParams)");
    int bp = 0;
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(1391)
// --------------------------------------------------------------

// public enum Element.BoxSizingMode :1391
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/Caching/$.uno(11)
// --------------------------------------------------------------------
...
uType* Cache_typeof()
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/0.23.2/Caching/$.uno");
    ::STRINGS[2] = uString::Const("PinAndValidate");
    ::TYPES[8] = ::g::Uno::Float_typeof();
    ::TYPES[9] = ::g::Uno::Recti_typeof();
    ::TYPES[7] = ::g::Fuse::Node_typeof();
    ...
    ::TYPES[13] = ::g::Uno::Graphics::RenderTarget_typeof();
    ::TYPES[14] = ::g::Fuse::DrawContext_typeof();
    ::TYPES[15] = ::g::Fuse::RootViewport_typeof();
    ::TYPES[16] = uObject_typeof();
    ::TYPES[17] = ::g::Fuse::Elements::CacheTile_typeof()->Array();
    ::TYPES[18] = ::g::Fuse::Elements::CacheTile_typeof();
    ::TYPES[19] = ::g::Fuse::CacheFramebuffer_typeof();
    ::TYPES[20] = ::g::Fuse::OrthographicFrustum_typeof();
    ::TYPES[21] = ::g::Fuse::IFrustum_typeof();
...
bool Cache::GetCachePreference(::g::Fuse::DrawContext* dc)
{
    ...
    if (uIs(uPtr(_element)->Parent(), ::TYPES[15/*Fuse.RootViewport*/]))
        ;
...
void Cache::PinAndValidate(::g::Fuse::DrawContext* dc)
{
    ...
    if (!::g::Uno::Recti::Equals2(cacheRect, _cacheRect))
    {
        ...
        if ((_cacheTiles == NULL) || (numTiles != uPtr(_cacheTiles)->Length()))
            _cacheTiles = uArray::New(::TYPES[17/*Fuse.Elements.CacheTile[]*/], numTiles);
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/Caching/$.uno(295)
// ---------------------------------------------------------------------
...
uType* CacheHelper_typeof()
{
    ...
    ::TYPES[23] = ::g::Fuse::Elements::Cache_typeof();
    ::TYPES[17] = ::g::Fuse::Elements::CacheTile_typeof()->Array();
    ::TYPES[24] = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall_typeof();
    ::TYPES[14] = ::g::Fuse::DrawContext_typeof();
    ::TYPES[8] = ::g::Uno::Float_typeof();
    ::TYPES[11] = ::g::Uno::Int2_typeof();
    ::TYPES[22] = ::g::Uno::Graphics::Texture2D_typeof();
    ::TYPES[18] = ::g::Fuse::Elements::CacheTile_typeof();
    ::TYPES[25] = ::g::Fuse::IViewport_typeof();
    ::TYPES[26] = ::g::Uno::Float2_typeof()->Array();
    ::TYPES[27] = ::g::FuseElements_bundle_typeof();
    type->SetFields(0,
...
void CacheHelper::Blit(::g::Fuse::DrawContext* dc, ::g::Fuse::Elements::Cache* cache, float opacity)
{
    ...
    for (array1 = uPtr(cache)->CacheTiles(), index2 = 0, length3 = uPtr(array1)->Length(); index2 < length3; ++index2)
    {
        ...
        _draw_934926a0.Uniform12(3, ::g::Fuse::IViewport::ViewProjectionTransform(uInterface(uPtr(dc->Viewport()), ::TYPES[25/*Fuse.IViewport*/])));
...
void CacheHelper::init_DrawCalls()
{
    ...
    uArray* Vertices_934926a0_1_0_0 = uArray::Init< ::g::Uno::Float2>(::TYPES[26/*float2[]*/], 6, ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(0.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 0.0f));
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/Caching/$.uno(105)
// ---------------------------------------------------------------------
...
uStructType* CacheTile_typeof()
{
    ...
    ::TYPES[11] = ::g::Uno::Int2_typeof();
    ::TYPES[9] = ::g::Uno::Recti_typeof();
    ::TYPES[28] = ::g::Uno::Graphics::Framebuffer_typeof();
    type->SetFields(0,
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(2055)
// --------------------------------------------------------------

// public enum CachingMode :2055
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(1749)
// --------------------------------------------------------------

// private sealed class TransformOrigins.CenterOrigin :1749
// {
...
// public generated CenterOrigin() :1749
void TransformOrigins__CenterOrigin__ctor__fn(TransformOrigins__CenterOrigin* __this)
{
    __this->ctor_();
}

// public float3 GetOffset(Fuse.Elements.Element elm) :1751
...
// public generated CenterOrigin New() :1749
...
// public generated CenterOrigin() [instance] :1749
void TransformOrigins__CenterOrigin::ctor_()
{
}

// public float3 GetOffset(Fuse.Elements.Element elm) [instance] :1751
...
// public generated CenterOrigin New() [static] :1749
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(227)
// -------------------------------------------------------------

// protected enum BoxSizing.ConstraintFlags :227
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/Caching/$.uno(425)
// ---------------------------------------------------------------------
...
uClassType* DisplayHelpers_typeof()
{
    ...
    ::TYPES[29] = ::g::Uno::Platform2::Display_typeof();
    ::TYPES[10] = ::g::Uno::Rect_typeof();
    return type;
}
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(73)
// ------------------------------------------------------------
...
static void Element__cctor_1_fn(uType* __type)
{
    ...
    Element::AspectProperty_ = (::g::Fuse::StyleProperty1__New1_fn(::TYPES[30/*Fuse.StyleProperty<Fuse.Elements.Element, float>*/], uCRef(1.0f), uDelegate::New(::TYPES[31/*Uno.Action<Fuse.Elements.Element>*/], (void*)::g::Fuse::Node__InvalidateLayout1_fn), &ret12), ret12);
    Element::CachingModeProperty_ = (::g::Fuse::StyleProperty1__New2_fn(::TYPES[32/*Fuse.StyleProperty<Fuse.Elements.Element, Fuse.Elements.CachingMode>*/], uCRef<int>(0), uDelegate::New(::TYPES[31/*Uno.Action<Fuse.Elements.Element>*/], (void*)Element__OnCachingModeChanged_fn), uDelegate::New(::TYPES[33/*Uno.Action<Fuse.Elements.Element, Fuse.Elements.CachingMode>*/], (void*)Element__SetCachingMode_fn), uDelegate::New(::TYPES[34/*Uno.Func<Fuse.Elements.Element, Fuse.Elements.CachingMode>*/], (void*)Element__GetCachingMode_fn), &ret13), ret13);
    Element::HitTestModeProperty_ = (::g::Fuse::StyleProperty1__New1_fn(::TYPES[35/*Fuse.StyleProperty<Fuse.Elements.Element, Fuse.Elements.HitTestMode>*/], uCRef<int>(5), NULL, &ret14), ret14);
    Element::WidthProperty_ = (::g::Fuse::StylePropertyWithUnit__New4_fn(::TYPES[36/*Fuse.StylePropertyWithUnit<Fuse.Elements.Element, float, Fuse.Elements.SizeUnit>*/], uCRef(0.0f), uCRef<int>(0), uDelegate::New(::TYPES[31/*Uno.Action<Fuse.Elements.Element>*/], (void*)::g::Fuse::Node__InvalidateLayout1_fn), uDelegate::New(::TYPES[37/*Uno.Action<Fuse.Elements.Element, float>*/], (void*)Element__SetWidth_fn), uDelegate::New(::TYPES[38/*Uno.Func<Fuse.Elements.Element, float>*/], (void*)Element__GetWidth_fn), &ret15), ret15);
    Element::HeightProperty_ = (::g::Fuse::StylePropertyWithUnit__New4_fn(::TYPES[36/*Fuse.StylePropertyWithUnit<Fuse.Elements.Element, float, Fuse.Elements.SizeUnit>*/], uCRef(0.0f), uCRef<int>(0), uDelegate::New(::TYPES[31/*Uno.Action<Fuse.Elements.Element>*/], (void*)::g::Fuse::Node__InvalidateLayout1_fn), uDelegate::New(::TYPES[37/*Uno.Action<Fuse.Elements.Element, float>*/], (void*)Element__SetHeight_fn), uDelegate::New(::TYPES[38/*Uno.Func<Fuse.Elements.Element, float>*/], (void*)Element__GetHeight_fn), &ret16), ret16);
    Element::MinWidthProperty_ = (::g::Fuse::StylePropertyWithUnit__New3_fn(::TYPES[36/*Fuse.StylePropertyWithUnit<Fuse.Elements.Element, float, Fuse.Elements.SizeUnit>*/], uCRef(0.0f), uCRef<int>(0), uDelegate::New(::TYPES[31/*Uno.Action<Fuse.Elements.Element>*/], (void*)::g::Fuse::Node__InvalidateLayout1_fn), &ret17), ret17);
    Element::MinHeightProperty_ = (::g::Fuse::StylePropertyWithUnit__New3_fn(::TYPES[36/*Fuse.StylePropertyWithUnit<Fuse.Elements.Element, float, Fuse.Elements.SizeUnit>*/], uCRef(0.0f), uCRef<int>(0), uDelegate::New(::TYPES[31/*Uno.Action<Fuse.Elements.Element>*/], (void*)::g::Fuse::Node__InvalidateLayout1_fn), &ret18), ret18);
    Element::MaxWidthProperty_ = (::g::Fuse::StylePropertyWithUnit__New3_fn(::TYPES[36/*Fuse.StylePropertyWithUnit<Fuse.Elements.Element, float, Fuse.Elements.SizeUnit>*/], uCRef(0.0f), uCRef<int>(0), uDelegate::New(::TYPES[31/*Uno.Action<Fuse.Elements.Element>*/], (void*)::g::Fuse::Node__InvalidateLayout1_fn), &ret19), ret19);
    Element::MaxHeightProperty_ = (::g::Fuse::StylePropertyWithUnit__New3_fn(::TYPES[36/*Fuse.StylePropertyWithUnit<Fuse.Elements.Element, float, Fuse.Elements.SizeUnit>*/], uCRef(0.0f), uCRef<int>(0), uDelegate::New(::TYPES[31/*Uno.Action<Fuse.Elements.Element>*/], (void*)::g::Fuse::Node__InvalidateLayout1_fn), &ret20), ret20);
    Element::AlignmentProperty_ = (::g::Fuse::StyleProperty1__New1_fn(::TYPES[39/*Fuse.StyleProperty<Fuse.Elements.Element, Fuse.Elements.Alignment>*/], uCRef<int>(0), uDelegate::New(::TYPES[31/*Uno.Action<Fuse.Elements.Element>*/], (void*)::g::Fuse::Node__InvalidateLayout1_fn), &ret21), ret21);
    Element::VisibilityProperty_ = (::g::Fuse::StyleProperty1__New1_fn(::TYPES[40/*Fuse.StyleProperty<Fuse.Elements.Element, Fuse.Elements.Visibility>*/], uCRef<int>(0), uDelegate::New(::TYPES[31/*Uno.Action<Fuse.Elements.Element>*/], (void*)Element__OnVisibilityChanged_fn), &ret22), ret22);
    Element::MarginProperty_ = (::g::Fuse::StyleProperty1__New1_fn(::TYPES[41/*Fuse.StyleProperty<Fuse.Elements.Element, float4>*/], uCRef(::g::Uno::Float4__New1(0.0f)), uDelegate::New(::TYPES[31/*Uno.Action<Fuse.Elements.Element>*/], (void*)::g::Fuse::Node__InvalidateLayout1_fn), &ret23), ret23);
    Element::PaddingProperty_ = (::g::Fuse::StyleProperty1__New1_fn(::TYPES[41/*Fuse.StyleProperty<Fuse.Elements.Element, float4>*/], uCRef(::g::Uno::Float4__New1(0.0f)), uDelegate::New(::TYPES[31/*Uno.Action<Fuse.Elements.Element>*/], (void*)::g::Fuse::Node__InvalidateLayout1_fn), &ret24), ret24);
    Element::OffsetProperty_ = (::g::Fuse::StylePropertyWithUnit__New3_fn(::TYPES[42/*Fuse.StylePropertyWithUnit<Fuse.Elements.Element, float2, Fuse.Elements.SizeUnit>*/], uCRef(::g::Uno::Float2__New1(0.0f)), uCRef<int>(0), uDelegate::New(::TYPES[31/*Uno.Action<Fuse.Elements.Element>*/], (void*)::g::Fuse::Node__InvalidateLayout1_fn), &ret25), ret25);
    Element::XProperty_ = (::g::Fuse::StylePropertyWithUnit__New3_fn(::TYPES[36/*Fuse.StylePropertyWithUnit<Fuse.Elements.Element, float, Fuse.Elements.SizeUnit>*/], uCRef(0.0f), uCRef<int>(0), uDelegate::New(::TYPES[31/*Uno.Action<Fuse.Elements.Element>*/], (void*)::g::Fuse::Node__InvalidateLayout1_fn), &ret26), ret26);
    Element::YProperty_ = (::g::Fuse::StylePropertyWithUnit__New3_fn(::TYPES[36/*Fuse.StylePropertyWithUnit<Fuse.Elements.Element, float, Fuse.Elements.SizeUnit>*/], uCRef(0.0f), uCRef<int>(0), uDelegate::New(::TYPES[31/*Uno.Action<Fuse.Elements.Element>*/], (void*)::g::Fuse::Node__InvalidateLayout1_fn), &ret27), ret27);
    Element::AnchorProperty_ = (::g::Fuse::StylePropertyWithUnit__New3_fn(::TYPES[42/*Fuse.StylePropertyWithUnit<Fuse.Elements.Element, float2, Fuse.Elements.SizeUnit>*/], uCRef(::g::Uno::Float2__New1(0.0f)), uCRef<int>(0), uDelegate::New(::TYPES[31/*Uno.Action<Fuse.Elements.Element>*/], (void*)::g::Fuse::Node__InvalidateLayout1_fn), &ret28), ret28);
    Element::ClipToBoundsProperty_ = (::g::Fuse::StyleProperty1__New1_fn(::TYPES[43/*Fuse.StyleProperty<Fuse.Elements.Element, bool>*/], uCRef(false), uDelegate::New(::TYPES[31/*Uno.Action<Fuse.Elements.Element>*/], (void*)Element__OnClipToBoundsChanged_fn), &ret29), ret29);
    Element::OpacityProperty_ = (::g::Fuse::StyleProperty1__New1_fn(::TYPES[30/*Fuse.StyleProperty<Fuse.Elements.Element, float>*/], uCRef(1.0f), uDelegate::New(::TYPES[31/*Uno.Action<Fuse.Elements.Element>*/], (void*)Element__OnOpacityChanged_fn), &ret30), ret30);
    Element::TransformOriginProperty_ = (::g::Fuse::StyleProperty1__New2_fn(::TYPES[44/*Fuse.StyleProperty<Fuse.Elements.Element, Fuse.Elements.ITransformOrigin>*/], ::g::Fuse::Elements::TransformOrigins::Center(), uDelegate::New(::TYPES[31/*Uno.Action<Fuse.Elements.Element>*/], (void*)Element__InvalidateLocalTransform1_fn), uDelegate::New(::TYPES[46/*Uno.Action<Fuse.Elements.Element, Fuse.Elements.ITransformOrigin>*/], (void*)Element__SetTransformOrigin_fn), uDelegate::New(::TYPES[47/*Uno.Func<Fuse.Elements.Element, Fuse.Elements.ITransformOrigin>*/], (void*)Element__GetTransformOrigin_fn), &ret31), ret31);
    Element::LimitHeightProperty_ = (::g::Fuse::StylePropertyWithUnit__New3_fn(::TYPES[36/*Fuse.StylePropertyWithUnit<Fuse.Elements.Element, float, Fuse.Elements.SizeUnit>*/], uCRef(0.0f), uCRef<int>(0), uDelegate::New(::TYPES[31/*Uno.Action<Fuse.Elements.Element>*/], (void*)::g::Fuse::Node__InvalidateLayout1_fn), &ret32), ret32);
    Element::LimitWidthProperty_ = (::g::Fuse::StylePropertyWithUnit__New3_fn(::TYPES[36/*Fuse.StylePropertyWithUnit<Fuse.Elements.Element, float, Fuse.Elements.SizeUnit>*/], uCRef(0.0f), uCRef<int>(0), uDelegate::New(::TYPES[31/*Uno.Action<Fuse.Elements.Element>*/], (void*)::g::Fuse::Node__InvalidateLayout1_fn), &ret33), ret33);
}
...
Element_type* Element_typeof()
{
    ...
    ::STRINGS[5] = uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno");
    ::STRINGS[6] = uString::Const("Draw called on a non-rooted node");
    ::STRINGS[7] = uString::Const("Draw");
    ::TYPES[30] = ::g::Fuse::StyleProperty1_typeof()->MakeType(Element_typeof(), ::g::Uno::Float_typeof());
    ::TYPES[31] = ::g::Uno::Action1_typeof()->MakeType(Element_typeof());
    ...
    ::TYPES[36] = ::g::Fuse::StylePropertyWithUnit_typeof()->MakeType(Element_typeof(), ::g::Uno::Float_typeof(), ::g::Fuse::Elements::SizeUnit_typeof());
    ::TYPES[37] = ::g::Uno::Action2_typeof()->MakeType(Element_typeof(), ::g::Uno::Float_typeof());
    ::TYPES[38] = ::g::Uno::Func1_typeof()->MakeType(Element_typeof(), ::g::Uno::Float_typeof());
    ...
    ::TYPES[41] = ::g::Fuse::StyleProperty1_typeof()->MakeType(Element_typeof(), ::g::Uno::Float4_typeof());
    ::TYPES[42] = ::g::Fuse::StylePropertyWithUnit_typeof()->MakeType(Element_typeof(), ::g::Uno::Float2_typeof(), ::g::Fuse::Elements::SizeUnit_typeof());
    ::TYPES[43] = ::g::Fuse::StyleProperty1_typeof()->MakeType(Element_typeof(), ::g::Uno::Bool_typeof());
    ::TYPES[44] = ::g::Fuse::StyleProperty1_typeof()->MakeType(Element_typeof(), ::g::Fuse::Elements::ITransformOrigin_typeof());
    ::TYPES[45] = ::g::Fuse::Elements::TransformOrigins_typeof();
    ::TYPES[46] = ::g::Uno::Action2_typeof()->MakeType(Element_typeof(), ::g::Fuse::Elements::ITransformOrigin_typeof());
    ::TYPES[47] = ::g::Uno::Func1_typeof()->MakeType(Element_typeof(), ::g::Fuse::Elements::ITransformOrigin_typeof());
    ::TYPES[48] = Element__GMSCacheItem_typeof()->Array();
    ::TYPES[49] = ::g::Fuse::Elements::BoxSizing_typeof();
    ::TYPES[50] = ::g::Fuse::Elements::StandardBoxSizing_typeof();
    ::TYPES[51] = ::g::Fuse::Effects::Effect_typeof();
    ::TYPES[52] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Effects::Effect_typeof());
    ::TYPES[53] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Effects::Effect_typeof());
    ::TYPES[10] = ::g::Uno::Rect_typeof();
    ::TYPES[7] = ::g::Fuse::Node_typeof();
    ::TYPES[0] = ::g::Uno::Int_typeof();
    ::TYPES[5] = ::g::Uno::Float2_typeof();
    ...
    ::TYPES[20] = ::g::Fuse::OrthographicFrustum_typeof();
    ::TYPES[21] = ::g::Fuse::IFrustum_typeof();
    ::TYPES[54] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Effects::Effect_typeof());
    ::TYPES[55] = ::g::Uno::Delegate_typeof();
    ::TYPES[56] = ::g::Fuse::PlacedHandler_typeof();
    ::TYPES[6] = ::g::Uno::Bool_typeof();
    ::TYPES[9] = ::g::Uno::Recti_typeof();
    ::TYPES[57] = Element__GMSCacheItem_typeof();
    ::TYPES[14] = ::g::Fuse::DrawContext_typeof();
    ::TYPES[8] = ::g::Uno::Float_typeof();
    ::TYPES[58] = ::g::Uno::EventHandler_typeof();
    ::TYPES[59] = ::g::Uno::EventArgs_typeof();
    ::TYPES[3] = ::g::Fuse::LayoutParams_typeof();
    ::TYPES[60] = ::g::Fuse::Elements::BoxPlacement_typeof();
    ::TYPES[61] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Effects::Effect_typeof());
    ::TYPES[62] = ::g::Fuse::HitTestContext_typeof();
    ::TYPES[63] = ::g::Fuse::Elements::PreplacementHandler_typeof();
    ::TYPES[64] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Fuse::Effects::Effect_typeof());
    ::TYPES[65] = ::g::Uno::Action_typeof();
    ::TYPES[66] = ::g::Fuse::Elements::NoImplicitMaxBoxSizing_typeof();
    ::TYPES[67] = ::g::Fuse::Elements::LimitBoxSizing_typeof();
    ::TYPES[68] = ::g::Fuse::Elements::LayoutMasterBoxSizing_typeof();
    ::TYPES[69] = ::g::Fuse::Elements::FillAspectBoxSizing_typeof();
    ::TYPES[70] = ::g::Fuse::NodeBounds_typeof();
    type->SetInterfaces(
...
// protected override sealed float2 get_AbsoluteViewportOrigin() :1292
...
// protected Uno.Rect CalcRenderBoundsWithEffects() :531
...
// internal override sealed bool get_CanAdjustMarginBox() :1512
...
// public framebuffer CaptureRegion(Fuse.DrawContext dc, Uno.Rect region, float2 padding) :662
...
void Element__Draw_fn(Element* __this, ::g::Fuse::DrawContext* dc)
{
    ...
    if (!__this->IsLocalRooted())
        ::g::Fuse::Diagnostics::Error(::STRINGS[6/*"Draw called...*/], __this, ::STRINGS[5/*"/usr/local/...*/], 695, ::STRINGS[7/*"Draw"*/]);
...
// public override sealed void DrawSelection(Fuse.DrawContext dc) :742
...
// public Uno.Collections.IList<Fuse.Effects.Effect> get_Effects() :767
void Element__get_Effects_fn(Element* __this, uObject** __retval)
{
    *__retval = __this->Effects();
}

// internal generated Fuse.Elements.ElementBatchEntry get_ElementBatchEntry() :851
...
// internal generated void set_ElementBatchEntry(Fuse.Elements.ElementBatchEntry value) :851
...
// protected virtual bool FastTrackDrawWithOpacity(Fuse.DrawContext dc) :874
...
// private void Fuse.Animations.IResize.SetSize(float2 size) :1612
...
// private float3 Fuse.IActualPlacement.get_ActualPosition() :1346
...
// private float3 Fuse.IActualPlacement.get_ActualSize() :1345
...
// private void Fuse.Triggers.Actions.ICollapse.Collapse() :515
...
// private void Fuse.Triggers.Actions.IHide.Hide() :516
...
// private void Fuse.Triggers.Actions.IShow.Show() :514
...
// protected internal float2 GetArrangePaddingSize(Fuse.LayoutParams lp) :1466
...
// private static Fuse.Elements.CachingMode GetCachingMode(Fuse.Elements.Element elm) :655
void Element__GetCachingMode_fn(Element* elm, int* __retval)
{
    *__retval = Element::GetCachingMode(elm);
}

// protected virtual float2 GetContentSize(Fuse.LayoutParams lp) :1461
...
// private static float GetHeight(Fuse.Elements.Element elm) :1082
void Element__GetHeight_fn(Element* elm, float* __retval)
{
    *__retval = Element::GetHeight(elm);
}

// public override sealed float2 GetMarginSize(Fuse.LayoutParams lp) :1435
...
// private static Fuse.Elements.ITransformOrigin GetTransformOrigin(Fuse.Elements.Element elm) :1800
void Element__GetTransformOrigin_fn(Element* elm, uObject** __retval)
{
    *__retval = Element::GetTransformOrigin(elm);
}

// internal Uno.Recti GetViewportInvertPixelRect(Fuse.DrawContext dc, Uno.Rect localRegion) :594
...
// public Uno.Recti GetVisibleViewportInvertPixelRect(Fuse.DrawContext dc, Uno.Rect localRegion) :610
...
// protected override sealed Fuse.NodeBounds get_HitTestLocalBounds() :1015
...
// protected virtual Fuse.NodeBounds get_HitTestLocalVisualBounds() :1029
...
// protected override sealed void InvalidateLocalTransform() :1843
...
// public void InvalidateVisualComposition() :1887
void Element__InvalidateVisualComposition_fn(Element* __this)
{
    __this->InvalidateVisualComposition();
}

// public override sealed bool get_IsLocalVisible() :1659
...
// protected override Fuse.LayoutDependent IsMarginBoxDependent(Fuse.Node child) :1905
...
// public bool IsPointInside(float2 localPoint) :979
...
// internal void LocalDraw(Fuse.DrawContext dc) :735
void Element__LocalDraw_fn(Element* __this, ::g::Fuse::DrawContext* dc)
{
    __this->LocalDraw(dc);
}

// public override sealed Uno.Rect get_LocalRenderBounds() :625
...
// protected override sealed float2 OnArrangeMarginBox(float2 position, Fuse.LayoutParams lp) :1478
...
// protected virtual void OnHitTestChildren(Fuse.HitTestContext htc) :1011
void Element__OnHitTestChildren_fn(Element* __this, ::g::Fuse::HitTestContext* htc)
{
}

// protected virtual void OnHitTestLocalVisual(Fuse.HitTestContext htc) :1010
void Element__OnHitTestLocalVisual_fn(Element* __this, ::g::Fuse::HitTestContext* htc)
{
}

// protected override void OnInvalidateLayout() :1899
...
// protected override sealed bool OnInvalidateRenderBounds() :1910
...
// private void OnInvalidateRenderBoundsWithEffects() :1925
void Element__OnInvalidateRenderBoundsWithEffects_fn(Element* __this)
{
    __this->OnInvalidateRenderBoundsWithEffects();
}

// protected override sealed void OnIsEnabledChanged() :1934
...
// private static void OnOpacityChanged(Fuse.Elements.Element elm) :1719
void Element__OnOpacityChanged_fn(Element* elm)
{
    Element::OnOpacityChanged(elm);
}

// internal void OnPreplacement() :1504
void Element__OnPreplacement_fn(Element* __this)
{
    __this->OnPreplacement();
}

// protected override void OnResetStyle() :1671
...
// protected override void OnRooted() :1630
void Element__OnRooted_fn(Element* __this)
{
    ...
    if (__this->HasEffects())
        ...
        for (uObject* enum7 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(__this->Effects()), ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::TYPES[51/*Fuse.Effects.Effect*/]))); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum7), ::g::Uno::Collections::IEnumerator_typeof())); )
        {
            ::g::Fuse::Effects::Effect* e = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum7), ::TYPES[54/*Uno.Collections.IEnumerator<Fuse.Effects.Effect>*/]), &ret40), ret40);
            uPtr(e)->Rooted();
        }
...
// protected override void OnUnrooted() :1646
void Element__OnUnrooted_fn(Element* __this)
{
    ...
    if (__this->HasEffects())
        ...
        for (uObject* enum8 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(__this->Effects()), ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::TYPES[51/*Fuse.Effects.Effect*/]))); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum8), ::g::Uno::Collections::IEnumerator_typeof())); )
        {
            ::g::Fuse::Effects::Effect* e = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum8), ::TYPES[54/*Uno.Collections.IEnumerator<Fuse.Effects.Effect>*/]), &ret41), ret41);
            uPtr(e)->Unrooted();
        }
...
// public generated void add_Placed(Fuse.PlacedHandler value) :1495
void Element__add_Placed_fn(Element* __this, uDelegate* value)
{
    __this->add_Placed(value);
}

// public generated void remove_Placed(Fuse.PlacedHandler value) :1495
void Element__remove_Placed_fn(Element* __this, uDelegate* value)
{
    __this->remove_Placed(value);
}

// protected override void PrependImplicitTransform(Fuse.FastMatrix m) :1834
...
// protected override sealed void PrependInverseTransformOrigin(Fuse.FastMatrix m) :1828
void Element__PrependInverseTransformOrigin_fn(Element* __this, ::g::Fuse::FastMatrix* m)
{
    ...
    ::g::Uno::Float3 off = ::g::Fuse::Elements::ITransformOrigin::GetOffset(uInterface(uPtr(__this->TransformOrigin()), ::TYPES[106/*Fuse.Elements.ITransformOrigin*/]), __this);
    uPtr(m)->PrependTranslation1(::g::Uno::Float3__op_UnaryNegation(off));
}

// protected override sealed void PrependTransformOrigin(Fuse.FastMatrix m) :1822
...
void Element::ctor_1()
{
    ...
    _gmsCache = uArray::New(::TYPES[48/*Fuse.Elements.Element.GMSCacheItem[]*/], 2);
...
// public float2 get_ActualAnchor() [instance] :1474
...
// internal void set_ActualAnchor(float2 value) [instance] :1475
...
// public float2 get_ActualPosition() [instance] :1305
...
// public float2 get_ActualSize() [instance] :1332
...
// public void AddStyleEffect(Fuse.Effects.Effect e) [instance] :774
void Element::AddStyleEffect(::g::Fuse::Effects::Effect* e)
{
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Effects()), ::TYPES[52/*Uno.Collections.ICollection<Fuse.Effects.Effect>*/]), e);
}

// public Fuse.Elements.Alignment get_Alignment() [instance] :1132
...
// public void set_Alignment(Fuse.Elements.Alignment value) [instance] :1133
...
// private Fuse.Elements.Element get_AncestorElement() [instance] :1695
...
// public float2 get_Anchor() [instance] :1220
...
// public void set_Anchor(float2 value) [instance] :1221
...
// public Fuse.Elements.Element.BoxSizingMode get_BoxSizing() [instance] :1404
...
// public void set_BoxSizing(Fuse.Elements.Element.BoxSizingMode value) [instance] :1405
...
// internal Fuse.Elements.BoxSizing get_BoxSizingObject() [instance] :1426
...
// private Fuse.Elements.Cache get_Cache() [instance] :848
...
// public Fuse.Elements.CachingMode get_CachingMode() [instance] :652
...
// public void set_CachingMode(Fuse.Elements.CachingMode value) [instance] :653
...
// protected Uno.Rect CalcRenderBoundsWithEffects() [instance] :531
::g::Uno::Rect Element::CalcRenderBoundsWithEffects()
{
    ...
    if (HasActiveEffects())
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Effects()), ::TYPES[52/*Uno.Collections.ICollection<Fuse.Effects.Effect>*/])); i++)
            if (uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Effects()), ::TYPES[53/*Uno.Collections.IList<Fuse.Effects.Effect>*/]), uCRef<int>(i), &ret34), ret34))->Active())
                r = uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Effects()), ::TYPES[53/*Uno.Collections.IList<Fuse.Effects.Effect>*/]), uCRef<int>(i), &ret35), ret35))->ModifyRenderBounds(r);

    return r;
}

// public framebuffer CaptureRegion(Fuse.DrawContext dc, Uno.Rect region, float2 padding) [instance] :662
::g::Uno::Graphics::Framebuffer* Element::CaptureRegion(::g::Fuse::DrawContext* dc, ::g::Uno::Rect region, ::g::Uno::Float2 padding)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[3/*"CaptureRegi...*/], uBox(::TYPES[11/*int2*/], fsz)), ::STRINGS[4/*", max-size: "*/]), uBox<int>(::TYPES[0/*int*/], ::g::Uno::Graphics::Texture2D::MaxSize())), 1, ::STRINGS[5/*"/usr/local/...*/], 671);
        return NULL;
    }
...
// public bool get_ClipToBounds() [instance] :1230
...
// public void set_ClipToBounds(bool value) [instance] :1231
...
// private void Composit(Fuse.DrawContext dc) [instance] :853
...
// internal void CompositEffects(Fuse.DrawContext dc) [instance] :879
void Element::CompositEffects(::g::Fuse::DrawContext* dc)
{
    ...
    if (hasActiveEffects)
        ...
        {
            ::g::Fuse::Effects::Effect* e = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum3), ::TYPES[54/*Uno.Collections.IEnumerator<Fuse.Effects.Effect>*/]), &ret36), ret36);
    ...
    if (hasActiveEffects && HasCompositionEffect())
        ...
        {
            ::g::Fuse::Effects::Effect* e1 = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum4), ::TYPES[54/*Uno.Collections.IEnumerator<Fuse.Effects.Effect>*/]), &ret37), ret37);
    ...
    if (hasActiveEffects)
        ...
        {
            ::g::Fuse::Effects::Effect* e2 = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum5), ::TYPES[54/*Uno.Collections.IEnumerator<Fuse.Effects.Effect>*/]), &ret38), ret38);
...
// private void DispatchPlacement() [instance] :1573
...
// public Uno.Collections.IList<Fuse.Effects.Effect> get_Effects() [instance] :767
uObject* Element::Effects()
{
    uStackFrame __("Fuse.Elements.Element", "get_Effects()");

    if (_effects == NULL)
        _effects = ((::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[64/*Uno.Collections.ObservableList<Fuse.Effects.Effect>*/], uDelegate::New(::TYPES[61/*Uno.Action<Fuse.Effects.Effect>*/], (void*)Element__OnEffectAdded_fn, this), uDelegate::New(::TYPES[61/*Uno.Action<Fuse.Effects.Effect>*/], (void*)Element__OnEffectRemoved_fn, this)));

    return (uObject*)_effects;
}

// internal generated Fuse.Elements.ElementBatchEntry get_ElementBatchEntry() [instance] :851
...
// internal generated void set_ElementBatchEntry(Fuse.Elements.ElementBatchEntry value) [instance] :851
...
// protected internal float2 GetArrangePaddingSize(Fuse.LayoutParams lp) [instance] :1466
...
// internal Uno.Recti GetViewportInvertPixelRect(Fuse.DrawContext dc, Uno.Rect localRegion) [instance] :594
...
// public Uno.Recti GetVisibleViewportInvertPixelRect(Fuse.DrawContext dc, Uno.Rect localRegion) [instance] :610
...
// private void GMSReset() [instance] :1385
...
// public bool get_HasActiveEffects() [instance] :789
bool Element::HasActiveEffects()
{
    ...
    if (HasEffects())
        ...
        {
            ::g::Fuse::Effects::Effect* e = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[54/*Uno.Collections.IEnumerator<Fuse.Effects.Effect>*/]), &ret52), ret52);
...
// public bool get_HasCompositionEffect() [instance] :809
...
// public bool get_HasEffects() [instance] :783
...
// public float get_Height() [instance] :1079
...
// public void set_Height(float value) [instance] :1080
...
// public Fuse.Elements.HitTestMode get_HitTestMode() [instance] :990
...
// public void set_HitTestMode(Fuse.Elements.HitTestMode value) [instance] :991
...
// internal float2 get_IntendedPosition() [instance] :1342
...
// internal float2 get_IntendedSize() [instance] :1337
...
// internal void InternArrangePaddingBox(Fuse.LayoutParams lp) [instance] :1587
...
// internal float2 InternGetContentSize(Fuse.LayoutParams lp) [instance] :1456
...
// public void InvalidateRenderBoundsWithEffects() [instance] :1941
...
// public void InvalidateVisualComposition() [instance] :1887
...
// public bool IsPointInside(float2 localPoint) [instance] :979
...
// public float get_LimitHeight() [instance] :2440
...
// public void set_LimitHeight(float value) [instance] :2441
...
// public float get_LimitWidth() [instance] :2449
...
// public void set_LimitWidth(float value) [instance] :2450
...
// internal void LocalDraw(Fuse.DrawContext dc) [instance] :735
...
// public float4 get_Margin() [instance] :1165
...
// public void set_Margin(float4 value) [instance] :1166
...
// public float get_MaxHeight() [instance] :1122
...
// public void set_MaxHeight(float value) [instance] :1123
...
// public float get_MaxWidth() [instance] :1112
...
// public void set_MaxWidth(float value) [instance] :1113
...
// public float get_MinHeight() [instance] :1102
...
// public void set_MinHeight(float value) [instance] :1103
...
// public float get_MinWidth() [instance] :1092
...
// public void set_MinWidth(float value) [instance] :1093
...
// private bool get_NeedsClipping() [instance] :562
...
// private void NotifyPropertyChanged() [instance] :1243
...
// public float2 get_Offset() [instance] :1187
...
// public void set_Offset(float2 value) [instance] :1188
...
// private void OnEffectAdded(Fuse.Effects.Effect e) [instance] :812
void Element::OnEffectAdded(::g::Fuse::Effects::Effect* e)
{
    ...
    uPtr(e)->Added(this);
    e->add_RenderingChanged(uDelegate::New(::TYPES[61/*Uno.Action<Fuse.Effects.Effect>*/], (void*)Element__OnEffectRenderingChanged_fn, this));
    e->add_RenderBoundsChanged(uDelegate::New(::TYPES[61/*Uno.Action<Fuse.Effects.Effect>*/], (void*)Element__OnEffectRenderBoundsChanged_fn, this));
    InvalidateVisual();
}

// private void OnEffectRemoved(Fuse.Effects.Effect e) [instance] :823
void Element::OnEffectRemoved(::g::Fuse::Effects::Effect* e)
{
    ...
    uPtr(e)->Removed(this);
    e->remove_RenderingChanged(uDelegate::New(::TYPES[61/*Uno.Action<Fuse.Effects.Effect>*/], (void*)Element__OnEffectRenderingChanged_fn, this));
    e->remove_RenderBoundsChanged(uDelegate::New(::TYPES[61/*Uno.Action<Fuse.Effects.Effect>*/], (void*)Element__OnEffectRenderBoundsChanged_fn, this));
    InvalidateVisual();
    e->AddedByStyle = false;
}

// private void OnEffectRenderBoundsChanged(Fuse.Effects.Effect e) [instance] :840
...
// private void OnEffectRenderingChanged(Fuse.Effects.Effect e) [instance] :835
...
// private void OnInvalidateRenderBoundsWithEffects() [instance] :1925
...
// internal void OnPreplacement() [instance] :1504
...
// public float get_Opacity() [instance] :1716
...
// public void set_Opacity(float value) [instance] :1717
...
// public float4 get_Padding() [instance] :1176
...
// public void set_Padding(float4 value) [instance] :1177
...
// internal void PerformPlacement(float2 position, float2 size, bool temp) [instance] :1524
void Element::PerformPlacement(::g::Uno::Float2 position, ::g::Uno::Float2 size, bool temp)
{
    ...
    if ((newParent || newPosition) || newSize)
    {
        if (!temp && !_pendingDispatchPlacement)
        {
            ...
            if (::g::Uno::Delegate::op_Inequality(Placed1, NULL))
            {
                ::g::Fuse::UpdateManager::AddDeferredAction(uDelegate::New(::TYPES[65/*Uno.Action*/], (void*)Element__DispatchPlacement_fn, this));
...
// public generated void add_Placed(Fuse.PlacedHandler value) [instance] :1495
void Element::add_Placed(uDelegate* value)
{
    uStackFrame __("Fuse.Elements.Element", "add_Placed(Fuse.PlacedHandler)");
    Placed1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Placed1, value), ::TYPES[56/*Fuse.PlacedHandler*/]);
}

// public generated void remove_Placed(Fuse.PlacedHandler value) [instance] :1495
void Element::remove_Placed(uDelegate* value)
{
    uStackFrame __("Fuse.Elements.Element", "remove_Placed(Fuse.PlacedHandler)");
    Placed1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Placed1, value), ::TYPES[56/*Fuse.PlacedHandler*/]);
}

// public generated void add_Preplacement(Fuse.Elements.PreplacementHandler value) [instance] :1497
void Element::add_Preplacement(uDelegate* value)
{
    ...
    Preplacement1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Preplacement1, value), ::TYPES[63/*Fuse.Elements.PreplacementHandler*/]);
}

// public generated void remove_Preplacement(Fuse.Elements.PreplacementHandler value) [instance] :1497
void Element::remove_Preplacement(uDelegate* value)
{
    ...
    Preplacement1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Preplacement1, value), ::TYPES[63/*Fuse.Elements.PreplacementHandler*/]);
}

// public generated void add_PropertyChanged(Uno.EventHandler value) [instance] :1241
void Element::add_PropertyChanged(uDelegate* value)
{
    ...
    PropertyChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(PropertyChanged1, value), ::TYPES[58/*Uno.EventHandler*/]);
}

// public generated void remove_PropertyChanged(Uno.EventHandler value) [instance] :1241
void Element::remove_PropertyChanged(uDelegate* value)
{
    ...
    PropertyChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(PropertyChanged1, value), ::TYPES[58/*Uno.EventHandler*/]);
}

// public Uno.Rect get_RenderBoundsWithEffects() [instance] :548
...
// public Uno.Rect get_RenderBoundsWithoutEffects() [instance] :568
...
// internal void RequestLayout() [instance] :1429
...
// public Fuse.Elements.ITransformOrigin get_TransformOrigin() [instance] :1797
...
// public void set_TransformOrigin(Fuse.Elements.ITransformOrigin value) [instance] :1798
...
// public Fuse.Elements.Visibility get_Visibility() [instance] :1142
...
// public void set_Visibility(Fuse.Elements.Visibility value) [instance] :1143
...
// public float get_Width() [instance] :1066
float Element::Width()
{
...
// public void set_Width(float value) [instance] :1067
...
// public float get_X() [instance] :1198
float Element::X()
{
...
// public void set_X(float value) [instance] :1199
...
// public float get_Y() [instance] :1209
float Element::Y()
{
...
// public void set_Y(float value) [instance] :1210
...
// private static Fuse.Elements.CachingMode GetCachingMode(Fuse.Elements.Element elm) [static] :655
...
// private static float GetHeight(Fuse.Elements.Element elm) [static] :1082
...
// private static Fuse.Elements.ITransformOrigin GetTransformOrigin(Fuse.Elements.Element elm) [static] :1800
...
// private static float GetWidth(Fuse.Elements.Element elm) [static] :1069
...
// private static void InvalidateLocalTransform(Fuse.Elements.Element elm) [static] :1808
...
// private static void OnCachingModeChanged(Fuse.Elements.Element elm) [static] :657
...
// private static void OnClipToBoundsChanged(Fuse.Elements.Element elm) [static] :1234
...
// private static void OnOpacityChanged(Fuse.Elements.Element elm) [static] :1719
...
// private static void OnVisibilityChanged(Fuse.Elements.Element elm) [static] :1147
...
// private static void SetCachingMode(Fuse.Elements.Element elm, Fuse.Elements.CachingMode value) [static] :656
...
// private static void SetHeight(Fuse.Elements.Element elm, float val) [static] :1083
...
// private static void SetTransformOrigin(Fuse.Elements.Element elm, Fuse.Elements.ITransformOrigin value) [static] :1804
...
// private static void SetWidth(Fuse.Elements.Element elm, float val) [static] :1070
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/Caching/$.uno(633)
// ---------------------------------------------------------------------
...
uType* ElementAtlas_typeof()
{
    ...
    ::TYPES[71] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Elements::Element_typeof());
    ::TYPES[72] = ::g::Fuse::Elements::ElementAtlasFramebuffer_typeof();
    ::TYPES[58] = ::g::Uno::EventHandler_typeof();
    ::TYPES[6] = ::g::Uno::Bool_typeof();
    ::TYPES[9] = ::g::Uno::Recti_typeof();
    ::TYPES[2] = ::g::Fuse::Elements::Element_typeof();
    ::TYPES[73] = ::g::Fuse::Elements::ElementBatchEntry_typeof();
    ::TYPES[14] = ::g::Fuse::DrawContext_typeof();
    ::TYPES[74] = ::g::Fuse::Elements::TextureAtlas_typeof();
    ::TYPES[75] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Elements::Element_typeof());
    ::TYPES[7] = ::g::Fuse::Node_typeof();
    ::TYPES[5] = ::g::Uno::Float2_typeof();
    ::TYPES[20] = ::g::Fuse::OrthographicFrustum_typeof();
    ::TYPES[25] = ::g::Fuse::IViewport_typeof();
...
void ElementAtlas::ctor_()
{
    ...
    _elements = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[71/*Uno.Collections.List<Fuse.Elements.Element>*/]));
    _framebuffer = ::g::Fuse::Elements::ElementAtlasFramebuffer::New1();
    uPtr(_framebuffer)->add_FramebufferCollected(uDelegate::New(::TYPES[58/*Uno.EventHandler*/], (void*)ElementAtlas__OnFramebufferCollected_fn, this));
...
void ElementAtlas::FillFramebuffer(::g::Fuse::DrawContext* dc, bool drawAll, ::g::Uno::Rect scissorRectInClipSpace)
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Elements::Element*> > enum2 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_elements), &ret7), ret7); enum2.MoveNext(::TYPES[75/*Uno.Collections.List<Fuse.Elements.Element>.Enumerator*/]); )
    {
        ::g::Fuse::Elements::Element* elm = enum2.Current(::TYPES[75/*Uno.Collections.List<Fuse.Elements.Element>.Enumerator*/]);
...
void ElementAtlas::OnFramebufferCollected(uObject* sender, ::g::Uno::EventArgs* eventArgs)
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Elements::Element*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_elements), &ret8), ret8); enum1.MoveNext(::TYPES[75/*Uno.Collections.List<Fuse.Elements.Element>.Enumerator*/]); )
    {
        ::g::Fuse::Elements::Element* elm = enum1.Current(::TYPES[75/*Uno.Collections.List<Fuse.Elements.Element>.Enumerator*/]);
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/Caching/$.uno(345)
// ---------------------------------------------------------------------
...
uType* ElementAtlasFramebuffer_typeof()
{
    ...
    ::TYPES[58] = ::g::Uno::EventHandler_typeof();
    ::TYPES[16] = uObject_typeof();
    ::TYPES[76] = ::g::Fuse::Elements::ElementAtlasFramebufferPoolEntry_typeof();
    ::TYPES[77] = ::g::Uno::Collections::LinkedListNode_typeof()->MakeType(::g::Fuse::Elements::ElementAtlasFramebufferPoolEntry_typeof());
    ::TYPES[6] = ::g::Uno::Bool_typeof();
    ::TYPES[78] = ::g::Fuse::Elements::ElementAtlasFramebufferPool_typeof();
    type->SetFields(0,
...
void ElementAtlasFramebuffer::add_FramebufferCollected(uDelegate* value)
{
    ...
    FramebufferCollected1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(FramebufferCollected1, value), ::TYPES[58/*Uno.EventHandler*/]);
}
...
void ElementAtlasFramebuffer::remove_FramebufferCollected(uDelegate* value)
{
    ...
    FramebufferCollected1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(FramebufferCollected1, value), ::TYPES[58/*Uno.EventHandler*/]);
}
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/Caching/$.uno(444)
// ---------------------------------------------------------------------
...
uClassType* ElementAtlasFramebufferPool_typeof()
{
    ...
    ::TYPES[29] = ::g::Uno::Platform2::Display_typeof();
    ::TYPES[58] = ::g::Uno::EventHandler_typeof();
    ::TYPES[79] = ::g::Fuse::Elements::DisplayHelpers_typeof();
    ::TYPES[11] = ::g::Uno::Int2_typeof();
    ::TYPES[22] = ::g::Uno::Graphics::Texture2D_typeof();
    ::TYPES[55] = ::g::Uno::Delegate_typeof();
    type->SetFields(0,
...
void ElementAtlasFramebufferPool::Initialize()
{
    ...
    ElementAtlasFramebufferPool::UpdateElementAtlasSize();
    uPtr(::g::Uno::Platform2::Display::MainDisplay())->add_FrameChanged(uDelegate::New(::TYPES[58/*Uno.EventHandler*/], (void*)ElementAtlasFramebufferPool__OnResized_fn));
...
void ElementAtlasFramebufferPool::add_AtlasSizeChanged(uDelegate* value)
{
    ...
    ElementAtlasFramebufferPool::AtlasSizeChanged1() = uCast<uDelegate*>(::g::Uno::Delegate::Combine(ElementAtlasFramebufferPool::AtlasSizeChanged1(), value), ::TYPES[58/*Uno.EventHandler*/]);
}
...
void ElementAtlasFramebufferPool::remove_AtlasSizeChanged(uDelegate* value)
{
    ...
    ElementAtlasFramebufferPool::AtlasSizeChanged1() = uCast<uDelegate*>(::g::Uno::Delegate::Remove(ElementAtlasFramebufferPool::AtlasSizeChanged1(), value), ::TYPES[58/*Uno.EventHandler*/]);
}
// }

// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/Caching/$.uno(403)
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/Caching/$.uno(516)
// ---------------------------------------------------------------------
...
ElementAtlasFramebufferPoolImpl_type* ElementAtlasFramebufferPoolImpl_typeof()
{
    ...
    ::TYPES[80] = ::g::Fuse::Resources::ISoftDisposable_typeof();
    ::TYPES[78] = ::g::Fuse::Elements::ElementAtlasFramebufferPool_typeof();
    ::TYPES[58] = ::g::Uno::EventHandler_typeof();
    ::TYPES[76] = ::g::Fuse::Elements::ElementAtlasFramebufferPoolEntry_typeof();
    ::TYPES[81] = ::g::Uno::Collections::LinkedList_typeof()->MakeType(::g::Fuse::Elements::ElementAtlasFramebufferPoolEntry_typeof());
    ::TYPES[77] = ::g::Uno::Collections::LinkedListNode_typeof()->MakeType(::g::Fuse::Elements::ElementAtlasFramebufferPoolEntry_typeof());
    ::TYPES[72] = ::g::Fuse::Elements::ElementAtlasFramebuffer_typeof();
    type->SetInterfaces(
...
void ElementAtlasFramebufferPoolImpl::ctor_()
{
    ...
    ::g::Fuse::Elements::ElementAtlasFramebufferPool::add_AtlasSizeChanged(uDelegate::New(::TYPES[58/*Uno.EventHandler*/], (void*)ElementAtlasFramebufferPoolImpl__OnAtlasSizeChanged_fn, this));
}
...
void ElementAtlasFramebufferPoolImpl::EnsurePool()
{
    ...
    _framebufferPool = ((::g::Uno::Collections::LinkedList*)::g::Uno::Collections::LinkedList::New1(::TYPES[81/*Uno.Collections.LinkedList<Fuse.Elements.ElementAtlasFramebufferPoolEntry>*/]));
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/Caching/$.uno(1233)
// ----------------------------------------------------------------------
...
ElementBatch_type* ElementBatch_typeof()
{
    ...
    ::TYPES[82] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Elements::ElementBatchEntry_typeof());
    ::TYPES[83] = ::g::Uno::Graphics::VertexAttributeInfo_typeof();
    ::TYPES[73] = ::g::Fuse::Elements::ElementBatchEntry_typeof();
    ::TYPES[2] = ::g::Fuse::Elements::Element_typeof();
    ::TYPES[10] = ::g::Uno::Rect_typeof();
    ::TYPES[11] = ::g::Uno::Int2_typeof();
    ::TYPES[84] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Elements::ElementBatchEntry_typeof());
    ::TYPES[6] = ::g::Uno::Bool_typeof();
    ::TYPES[28] = ::g::Uno::Graphics::Framebuffer_typeof();
    ::TYPES[7] = ::g::Fuse::Node_typeof();
    ::TYPES[24] = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall_typeof();
    ::TYPES[14] = ::g::Fuse::DrawContext_typeof();
    ::TYPES[85] = ::g::Uno::UShort_typeof();
    ::TYPES[86] = ::g::Uno::Float4x4_typeof();
    ::TYPES[87] = ::g::Uno::Float4_typeof();
    ::TYPES[9] = ::g::Uno::Recti_typeof();
    ::TYPES[5] = ::g::Uno::Float2_typeof();
    ::TYPES[74] = ::g::Fuse::Elements::TextureAtlas_typeof();
    ::TYPES[88] = ::g::Fuse::Elements::ElementAtlas_typeof();
    ::TYPES[27] = ::g::FuseElements_bundle_typeof();
    type->SetInterfaces(
...
void ElementBatch::ctor_(::g::Fuse::Elements::ElementBatcher* elementBatcher, ::g::Fuse::Elements::ElementAtlas* elementAtlas)
{
    ...
    _elements = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[82/*Uno.Collections.List<Fuse.Elements.ElementBatchEntry>*/]));
...
void ElementBatch::Dispose()
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Elements::ElementBatchEntry*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_elements), &ret8), ret8); enum1.MoveNext(::TYPES[84/*Uno.Collections.List<Fuse.Elements.ElementBatchEntry>.Enumerator*/]); )
    {
        ::g::Fuse::Elements::ElementBatchEntry* elm = enum1.Current(::TYPES[84/*Uno.Collections.List<Fuse.Elements.ElementBatchEntry>.Enumerator*/]);
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/Caching/$.uno(1168)
// ----------------------------------------------------------------------
...
uType* ElementBatchEntry_typeof()
{
    ...
    ::TYPES[0] = ::g::Uno::Int_typeof();
    ::TYPES[2] = ::g::Fuse::Elements::Element_typeof();
    ::TYPES[89] = ::g::Fuse::Elements::ElementBatcher_typeof();
    ::TYPES[90] = ::g::Fuse::Elements::ElementBatch_typeof();
    type->SetFields(0,
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/Caching/$.uno(863)
// ---------------------------------------------------------------------
...
ElementBatcher_type* ElementBatcher_typeof()
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/0.23.2/Caching/$.uno");
    ::TYPES[91] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[92] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Elements::ElementAtlas_typeof());
    ::TYPES[93] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Elements::ElementBatch_typeof());
    ::TYPES[94] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Elements::IElementBatchDrawable_typeof());
    ::TYPES[82] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Elements::ElementBatchEntry_typeof());
    ::TYPES[80] = ::g::Fuse::Resources::ISoftDisposable_typeof();
    ::TYPES[78] = ::g::Fuse::Elements::ElementAtlasFramebufferPool_typeof();
    ::TYPES[58] = ::g::Uno::EventHandler_typeof();
    ::TYPES[95] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Elements::ElementAtlas_typeof());
    ::TYPES[96] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[2] = ::g::Fuse::Elements::Element_typeof();
    ::TYPES[97] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Elements::ElementBatch_typeof());
    ::TYPES[12] = ::g::Uno::Double_typeof();
    ::TYPES[88] = ::g::Fuse::Elements::ElementAtlas_typeof();
    ::TYPES[73] = ::g::Fuse::Elements::ElementBatchEntry_typeof();
    ::TYPES[84] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Elements::ElementBatchEntry_typeof());
    ...
    ::TYPES[9] = ::g::Uno::Recti_typeof();
    ::TYPES[7] = ::g::Fuse::Node_typeof();
    ::TYPES[98] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Elements::IElementBatchDrawable_typeof());
    ::TYPES[0] = ::g::Uno::Int_typeof();
    ::TYPES[79] = ::g::Fuse::Elements::DisplayHelpers_typeof();
    ::TYPES[99] = ::g::Fuse::Elements::IElementBatchDrawable_typeof();
    ::TYPES[90] = ::g::Fuse::Elements::ElementBatch_typeof();
    ::TYPES[5] = ::g::Uno::Float2_typeof();
    ::TYPES[10] = ::g::Uno::Rect_typeof();
    ::TYPES[8] = ::g::Uno::Float_typeof();
...
void ElementBatcher::ctor_()
{
    ...
    _elements = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[91/*Uno.Collections.List<Fuse.Node>*/]));
    _atlasPool = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[92/*Uno.Collections.List<Fuse.Elements.ElementAtlas>*/]));
    _batchPool = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[93/*Uno.Collections.List<Fuse.Elements.ElementBatch>*/]));
    _drawList = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[94/*Uno.Collections.List<Fuse.Elements.IElementBatchDrawable>*/]));
    _reinsertCheckList = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[82/*Uno.Collections.List<Fuse.Elements.ElementBatchEntry>*/]));
    ::g::Fuse::Resources::DisposalManager::Add1((uObject*)this);
    ::g::Fuse::Elements::ElementAtlasFramebufferPool::add_AtlasSizeChanged(uDelegate::New(::TYPES[58/*Uno.EventHandler*/], (void*)ElementBatcher__OnAtlasSizeChanged_fn, this));
}
...
void ElementBatcher::DiscardAtlasing()
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Elements::ElementAtlas*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_atlasPool), &ret14), ret14); enum1.MoveNext(::TYPES[95/*Uno.Collections.List<Fuse.Elements.ElementAtlas>.Enumerator*/]); )
    {
        ::g::Fuse::Elements::ElementAtlas* atlas = enum1.Current(::TYPES[95/*Uno.Collections.List<Fuse.Elements.ElementAtlas>.Enumerator*/]);
        uPtr(atlas)->Dispose();
    }

    uPtr(_atlasPool)->Clear();

    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Node*> > enum2 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_elements), &ret15), ret15); enum2.MoveNext(::TYPES[96/*Uno.Collections.List<Fuse.Node>.Enumerator*/]); )
    {
        ::g::Fuse::Node* node = enum2.Current(::TYPES[96/*Uno.Collections.List<Fuse.Node>.Enumerator*/]);
...
void ElementBatcher::DiscardBatching()
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Elements::ElementBatch*> > enum3 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_batchPool), &ret16), ret16); enum3.MoveNext(::TYPES[97/*Uno.Collections.List<Fuse.Elements.ElementBatch>.Enumerator*/]); )
    {
        ::g::Fuse::Elements::ElementBatch* batch = enum3.Current(::TYPES[97/*Uno.Collections.List<Fuse.Elements.ElementBatch>.Enumerator*/]);
        uPtr(batch)->Dispose();
    }
...
void ElementBatcher::Draw(::g::Fuse::DrawContext* dc)
{
    ...
    {
        ::g::Uno::Collections::List* removeList = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[92/*Uno.Collections.List<Fuse.Elements.ElementAtlas>*/]);

        for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Elements::ElementAtlas*> > enum7 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_atlasPool), &ret17), ret17); enum7.MoveNext(::TYPES[95/*Uno.Collections.List<Fuse.Elements.ElementAtlas>.Enumerator*/]); )
        {
            ::g::Fuse::Elements::ElementAtlas* a = enum7.Current(::TYPES[95/*Uno.Collections.List<Fuse.Elements.ElementAtlas>.Enumerator*/]);

            if ((double)uPtr(a)->SpilledRatio() > 0.5)
                ::g::Uno::Collections::List__Add_fn(uPtr(removeList), a);
        }

        for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Node*> > enum8 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_elements), &ret18), ret18); enum8.MoveNext(::TYPES[96/*Uno.Collections.List<Fuse.Node>.Enumerator*/]); )
        {
            ::g::Fuse::Node* node = enum8.Current(::TYPES[96/*Uno.Collections.List<Fuse.Node>.Enumerator*/]);
            ::g::Fuse::Elements::Element* elm = uAs< ::g::Fuse::Elements::Element*>(node, ::TYPES[2/*Fuse.Elements.Element*/]);

            if (elm == NULL)
                continue;

            for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Elements::ElementAtlas*> > enum9 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(removeList), &ret19), ret19); enum9.MoveNext(::TYPES[95/*Uno.Collections.List<Fuse.Elements.ElementAtlas>.Enumerator*/]); )
            {
                ::g::Fuse::Elements::ElementAtlas* a1 = enum9.Current(::TYPES[95/*Uno.Collections.List<Fuse.Elements.ElementAtlas>.Enumerator*/]);
        ...
        for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Elements::ElementAtlas*> > enum10 = (::g::Uno::Collections::List__GetEnumerator_fn(removeList, &ret20), ret20); enum10.MoveNext(::TYPES[95/*Uno.Collections.List<Fuse.Elements.ElementAtlas>.Enumerator*/]); )
        {
            ::g::Fuse::Elements::ElementAtlas* a2 = enum10.Current(::TYPES[95/*Uno.Collections.List<Fuse.Elements.ElementAtlas>.Enumerator*/]);
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Elements::ElementBatchEntry*> > enum11 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_reinsertCheckList), &ret22), ret22); enum11.MoveNext(::TYPES[84/*Uno.Collections.List<Fuse.Elements.ElementBatchEntry>.Enumerator*/]); )
    {
        ::g::Fuse::Elements::ElementBatchEntry* e = enum11.Current(::TYPES[84/*Uno.Collections.List<Fuse.Elements.ElementBatchEntry>.Enumerator*/]);
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong<uObject*> > enum12 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_drawList), &ret24), ret24); enum12.MoveNext(::TYPES[98/*Uno.Collections.List<Fuse.Elements.IElementBatchDrawable>.Enumerator*/]); )
    {
        uObject* d = enum12.Current(::TYPES[98/*Uno.Collections.List<Fuse.Elements.IElementBatchDrawable>.Enumerator*/]);
        ::g::Fuse::Elements::IElementBatchDrawable::Draw(uInterface(uPtr(d), ::TYPES[99/*Fuse.Elements.IElementBatchDrawable*/]), dc, localToClipTransform, scissorRectInClipSpace);
    }
}
...
void ElementBatcher::UpdateDrawList()
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Node*> > enum4 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_elements), &ret25), ret25); enum4.MoveNext(::TYPES[96/*Uno.Collections.List<Fuse.Node>.Enumerator*/]); )
    {
        ::g::Fuse::Node* node = enum4.Current(::TYPES[96/*Uno.Collections.List<Fuse.Node>.Enumerator*/]);
        ...
        if (emitNewBatch || (atlas == NULL))
        {
            if (atlas == NULL)
            {
                for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Elements::ElementAtlas*> > enum5 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_atlasPool), &ret26), ret26); enum5.MoveNext(::TYPES[95/*Uno.Collections.List<Fuse.Elements.ElementAtlas>.Enumerator*/]); )
                {
                    ::g::Fuse::Elements::ElementAtlas* a = enum5.Current(::TYPES[95/*Uno.Collections.List<Fuse.Elements.ElementAtlas>.Enumerator*/]);
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Elements::ElementAtlas*> > enum6 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_atlasPool), &ret27), ret27); enum6.MoveNext(::TYPES[95/*Uno.Collections.List<Fuse.Elements.ElementAtlas>.Enumerator*/]); )
    {
        ::g::Fuse::Elements::ElementAtlas* a1 = enum6.Current(::TYPES[95/*Uno.Collections.List<Fuse.Elements.ElementAtlas>.Enumerator*/]);
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(8)
// -----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(1374)
// --------------------------------------------------------------

// private struct Element.GMSCacheItem :1374
// {
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(965)
// -------------------------------------------------------------

// public enum HitTestMode :965
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/Caching/$.uno(844)
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(2101)
// --------------------------------------------------------------

// public sealed class InteractiveTransform :2101
// {
::g::Fuse::Transform_type* InteractiveTransform_typeof()
{
    ...
    ::TYPES[5] = ::g::Uno::Float2_typeof();
    ::TYPES[55] = ::g::Uno::Delegate_typeof();
    ::TYPES[100] = ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::g::Uno::Float_typeof());
    ::TYPES[16] = uObject_typeof();
    ::TYPES[101] = ::g::Uno::UX::ValueChangedArgs_typeof()->MakeType(::g::Uno::Float_typeof());
    ::TYPES[102] = ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[103] = ::g::Uno::UX::ValueChangedArgs_typeof()->MakeType(::g::Uno::Float2_typeof());
    type->SetFields(4,
...
// public generated InteractiveTransform() :2101
void InteractiveTransform__ctor_1_fn(InteractiveTransform* __this)
{
    __this->ctor_1();
}

// internal void AppendRotationScale(Fuse.FastMatrix matrix) :2174
...
// public override sealed void AppendTo(Fuse.FastMatrix matrix, [float weight]) :2167
...
// public override sealed bool get_IsFlat() :2158
...
// public generated InteractiveTransform New() :2101
void InteractiveTransform__New1_fn(InteractiveTransform** __retval)
{
    *__retval = InteractiveTransform::New1();
}

// public override sealed void PrependTo(Fuse.FastMatrix matrix) :2160
...
// private generated void remove_RotationChanged(Uno.UX.ValueChangedHandler<float> value) :2130
...
// public void SetRotation(float value, [object origin]) :2132
...
// public void SetTranslation(float2 value, [object origin]) :2150
...
// public void SetZoomFactor(float value, [object origin]) :2113
...
// public float2 get_Translation() :2144
...
// public void set_Translation(float2 value) :2145
void InteractiveTransform__set_Translation_fn(InteractiveTransform* __this, ::g::Uno::Float2* value)
{
    __this->Translation(*value);
}

// private generated void add_TranslationChanged(Uno.UX.ValueChangedHandler<float2> value) :2148
...
// private generated void remove_TranslationChanged(Uno.UX.ValueChangedHandler<float2> value) :2148
...
// private generated void remove_ZoomFactorChanged(Uno.UX.ValueChangedHandler<float> value) :2111
...
// public generated InteractiveTransform() [instance] :2101
...
// internal void AppendRotationScale(Fuse.FastMatrix matrix) [instance] :2174
...
// public float get_Rotation() [instance] :2126
...
// public void set_Rotation(float value) [instance] :2127
...
// private generated void add_RotationChanged(Uno.UX.ValueChangedHandler<float> value) [instance] :2130
void InteractiveTransform::add_RotationChanged(uDelegate* value)
{
    ...
    RotationChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(RotationChanged1, value), ::TYPES[100/*Uno.UX.ValueChangedHandler<float>*/]);
}

// private generated void remove_RotationChanged(Uno.UX.ValueChangedHandler<float> value) [instance] :2130
void InteractiveTransform::remove_RotationChanged(uDelegate* value)
{
    ...
    RotationChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(RotationChanged1, value), ::TYPES[100/*Uno.UX.ValueChangedHandler<float>*/]);
}

// public void SetRotation(float value, [object origin]) [instance] :2132
void InteractiveTransform::SetRotation(float value, uObject* origin)
{
    ...
    if (::g::Uno::Delegate::op_Inequality(RotationChanged1, NULL))
        uPtr(RotationChanged1)->Invoke(2, this, (::g::Uno::UX::ValueChangedArgs__New2_fn(::TYPES[101/*Uno.UX.ValueChangedArgs<float>*/], uCRef(_rotation), (origin != NULL) ? origin : this, &ret2), ret2));

    OnMatrixChanged();
}

// public void SetTranslation(float2 value, [object origin]) [instance] :2150
void InteractiveTransform::SetTranslation(::g::Uno::Float2 value, uObject* origin)
{
    ...
    if (::g::Uno::Delegate::op_Inequality(TranslationChanged1, NULL))
        uPtr(TranslationChanged1)->Invoke(2, this, (::g::Uno::UX::ValueChangedArgs__New2_fn(::TYPES[103/*Uno.UX.ValueChangedArgs<float2>*/], uCRef(_translation), (origin != NULL) ? origin : this, &ret3), ret3));

    OnMatrixChanged();
}

// public void SetZoomFactor(float value, [object origin]) [instance] :2113
void InteractiveTransform::SetZoomFactor(float value, uObject* origin)
{
    ...
    if (::g::Uno::Delegate::op_Inequality(ZoomFactorChanged1, NULL))
        uPtr(ZoomFactorChanged1)->Invoke(2, this, (::g::Uno::UX::ValueChangedArgs__New2_fn(::TYPES[101/*Uno.UX.ValueChangedArgs<float>*/], uCRef(_zoomFactor), (origin != NULL) ? origin : this, &ret4), ret4));

    OnMatrixChanged();
}

// public float2 get_Translation() [instance] :2144
...
// public void set_Translation(float2 value) [instance] :2145
...
// private generated void add_TranslationChanged(Uno.UX.ValueChangedHandler<float2> value) [instance] :2148
void InteractiveTransform::add_TranslationChanged(uDelegate* value)
{
    ...
    TranslationChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(TranslationChanged1, value), ::TYPES[102/*Uno.UX.ValueChangedHandler<float2>*/]);
}

// private generated void remove_TranslationChanged(Uno.UX.ValueChangedHandler<float2> value) [instance] :2148
void InteractiveTransform::remove_TranslationChanged(uDelegate* value)
{
    ...
    TranslationChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(TranslationChanged1, value), ::TYPES[102/*Uno.UX.ValueChangedHandler<float2>*/]);
}

// public float get_ZoomFactor() [instance] :2107
...
// public void set_ZoomFactor(float value) [instance] :2108
...
// private generated void add_ZoomFactorChanged(Uno.UX.ValueChangedHandler<float> value) [instance] :2111
void InteractiveTransform::add_ZoomFactorChanged(uDelegate* value)
{
    ...
    ZoomFactorChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(ZoomFactorChanged1, value), ::TYPES[100/*Uno.UX.ValueChangedHandler<float>*/]);
}

// private generated void remove_ZoomFactorChanged(Uno.UX.ValueChangedHandler<float> value) [instance] :2111
void InteractiveTransform::remove_ZoomFactorChanged(uDelegate* value)
{
    ...
    ZoomFactorChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(ZoomFactorChanged1, value), ::TYPES[100/*Uno.UX.ValueChangedHandler<float>*/]);
}

// public generated InteractiveTransform New() [static] :2101
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(1737)
// --------------------------------------------------------------

// public abstract interface ITransformOrigin :1737
// {
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(2196)
// --------------------------------------------------------------

// public sealed class LayoutMasterBoxSizing :2196
// {
// static LayoutMasterBoxSizing() :2196
...
::g::Fuse::Elements::BoxSizing_type* LayoutMasterBoxSizing_typeof()
{
    ...
    ::TYPES[60] = ::g::Fuse::Elements::BoxPlacement_typeof();
    ::TYPES[2] = ::g::Fuse::Elements::Element_typeof();
    ::TYPES[104] = LayoutMasterBoxSizing__LayoutMasterData_typeof();
    ::TYPES[7] = ::g::Fuse::Node_typeof();
    ::TYPES[16] = uObject_typeof();
    type->SetFields(0,
...
// public generated LayoutMasterBoxSizing() :2196
void LayoutMasterBoxSizing__ctor_1_fn(LayoutMasterBoxSizing* __this)
{
    __this->ctor_1();
}

// public override sealed float2 CalcArrangePaddingSize(Fuse.Elements.Element element, Fuse.LayoutParams lp) :2231
...
// public override sealed Fuse.Elements.BoxPlacement CalcBoxPlacement(Fuse.Elements.Element element, float2 position, Fuse.LayoutParams lp) :2200
...
// public override sealed float2 CalcMarginSize(Fuse.Elements.Element element, Fuse.LayoutParams lp) :2222
...
// public static Fuse.Elements.Element GetLayoutMaster(Fuse.Elements.Element elm) :2346
...
// private static Fuse.Elements.LayoutMasterBoxSizing.LayoutMasterData GetLayoutMasterData(Fuse.Elements.Element elm) :2321
...
// public static Fuse.Elements.LayoutMasterMode GetLayoutMasterMode(Fuse.Elements.Element elm) :2364
...
// public override sealed Fuse.LayoutDependent IsContentRelativeSize(Fuse.Elements.Element element) :2333
...
// public generated LayoutMasterBoxSizing New() :2196
void LayoutMasterBoxSizing__New1_fn(LayoutMasterBoxSizing** __retval)
{
    *__retval = LayoutMasterBoxSizing::New1();
}

// public override sealed void RequestLayout(Fuse.Elements.Element element) :2216
...
// public static void ResetLayoutMaster(Fuse.Elements.Element elm) :2352
void LayoutMasterBoxSizing__ResetLayoutMaster_fn(::g::Fuse::Elements::Element* elm)
{
    LayoutMasterBoxSizing::ResetLayoutMaster(elm);
}

// public static void SetLayoutMaster(Fuse.Elements.Element elm, Fuse.Elements.Element master) :2340
...
// public static void SetLayoutMasterMode(Fuse.Elements.Element elm, Fuse.Elements.LayoutMasterMode mode) :2358
...
// public generated LayoutMasterBoxSizing() [instance] :2196
...
// public static Fuse.Elements.Element GetLayoutMaster(Fuse.Elements.Element elm) [static] :2346
...
// private static Fuse.Elements.LayoutMasterBoxSizing.LayoutMasterData GetLayoutMasterData(Fuse.Elements.Element elm) [static] :2321
LayoutMasterBoxSizing__LayoutMasterData* LayoutMasterBoxSizing::GetLayoutMasterData(::g::Fuse::Elements::Element* elm)
{
    ...
    if (uPtr(uPtr(elm)->Properties())->TryGet(LayoutMasterBoxSizing::_layoutMasterDataProperty(), &v))
        return uCast<LayoutMasterBoxSizing__LayoutMasterData*>(v, ::TYPES[104/*Fuse.Elements.LayoutMasterBoxSizing.LayoutMasterData*/]);
...
// public static Fuse.Elements.LayoutMasterMode GetLayoutMasterMode(Fuse.Elements.Element elm) [static] :2364
...
// public generated LayoutMasterBoxSizing New() [static] :2196
...
// public static void ResetLayoutMaster(Fuse.Elements.Element elm) [static] :2352
...
// public static void SetLayoutMaster(Fuse.Elements.Element elm, Fuse.Elements.Element master) [static] :2340
...
// public static void SetLayoutMasterMode(Fuse.Elements.Element elm, Fuse.Elements.LayoutMasterMode mode) [static] :2358
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(2238)
// --------------------------------------------------------------

// private sealed class LayoutMasterBoxSizing.LayoutMasterData :2238
// {
...
// public void set_Master(Fuse.Elements.Element value) :2249
...
// public generated LayoutMasterData New() :2238
...
// private void OnPlaced(object s, object args) :2315
...
// internal void ScheduleCheckLayout() :2271
...
// public generated LayoutMasterData() [instance] :2238
void LayoutMasterBoxSizing__LayoutMasterData::ctor_()
{
}

// internal void CheckLayout() [instance] :2281
...
// public Fuse.Elements.Element get_Master() [instance] :2248
...
// public void set_Master(Fuse.Elements.Element value) [instance] :2249
void LayoutMasterBoxSizing__LayoutMasterData::Master(::g::Fuse::Elements::Element* value)
{
    ...
    if (_master != NULL)
        uPtr(_master)->remove_Placed(uDelegate::New(::TYPES[56/*Fuse.PlacedHandler*/], (void*)LayoutMasterBoxSizing__LayoutMasterData__OnPlaced_fn, this));

    _master = value;

    if (_master != NULL)
        uPtr(_master)->add_Placed(uDelegate::New(::TYPES[56/*Fuse.PlacedHandler*/], (void*)LayoutMasterBoxSizing__LayoutMasterData__OnPlaced_fn, this));

    if (uPtr(Element)->IsLocalRooted())
        ScheduleCheckLayout();
}

// private void OnPlaced(object s, object args) [instance] :2315
void LayoutMasterBoxSizing__LayoutMasterData::OnPlaced(uObject* s, uObject* args)
{
    ...
    ::g::Fuse::UpdateManager::AddDeferredAction(uDelegate::New(::TYPES[65/*Uno.Action*/], (void*)LayoutMasterBoxSizing__LayoutMasterData__CheckLayout_fn, this));
}

// internal void ScheduleCheckLayout() [instance] :2271
...
// public generated LayoutMasterData New() [static] :2238
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(2189)
// --------------------------------------------------------------

// public enum LayoutMasterMode :2189
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(2379)
// --------------------------------------------------------------

// public sealed class LimitBoxSizing :2379
// {
// static LimitBoxSizing() :2379
...
// public generated LimitBoxSizing() :2379
void LimitBoxSizing__ctor_1_fn(LimitBoxSizing* __this)
{
    __this->ctor_1();
}

// public override sealed float2 CalcArrangePaddingSize(Fuse.Elements.Element element, Fuse.LayoutParams lp) :2399
...
// public override sealed Fuse.Elements.BoxPlacement CalcBoxPlacement(Fuse.Elements.Element element, float2 position, Fuse.LayoutParams lp) :2383
...
// public override sealed float2 CalcMarginSize(Fuse.Elements.Element element, Fuse.LayoutParams lp) :2388
...
// private float2 Limit(Fuse.Elements.Element element, float2 std) :2404
...
// public generated LimitBoxSizing New() :2379
...
// public generated LimitBoxSizing() [instance] :2379
...
// private float2 Limit(Fuse.Elements.Element element, float2 std) [instance] :2404
...
// public generated LimitBoxSizing New() [static] :2379
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(495)
// -------------------------------------------------------------

// internal sealed class NoImplicitMaxBoxSizing :495
// {
// static NoImplicitMaxBoxSizing() :495
...
// public NoImplicitMaxBoxSizing() :499
void NoImplicitMaxBoxSizing__ctor_2_fn(NoImplicitMaxBoxSizing* __this)
{
    __this->ctor_2();
}

// public NoImplicitMaxBoxSizing New() :499
...
// public NoImplicitMaxBoxSizing() [instance] :499
...
// public NoImplicitMaxBoxSizing New() [static] :499
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(2466)
// --------------------------------------------------------------

// private class TranslationModes.OffsetMode :2466
// {
...
// protected virtual float3 GetDstOffset(Fuse.Elements.Element e) :2492
...
// protected virtual float3 GetSrcOffset(Fuse.Elements.Element e) :2493
...
// public generated OffsetMode() [instance] :2466
void TranslationModes__OffsetMode::ctor_()
{
}

// public Fuse.TransformModeFlags get_Flags() [instance] :2490
...
// public float3 GetAbsVector(Fuse.Translation t) [instance] :2468
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(2496)
// --------------------------------------------------------------

// private sealed class TranslationModes.PositionOffsetMode :2496
// {
...
// public generated PositionOffsetMode() [instance] :2496
...
// public generated PositionOffsetMode New() [static] :2496
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(1275)
// --------------------------------------------------------------

// public sealed class PreplacementArgs :1275
// {
...
// public generated bool get_HasPrev() [instance] :1278
...
// private generated void set_HasPrev(bool value) [instance] :1278
...
// internal PreplacementArgs New(bool hasPrev) [static] :1280
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(1286)
// --------------------------------------------------------------

// public delegate void PreplacementHandler(object sender, Fuse.Elements.PreplacementArgs args) :1286
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(2048)
// --------------------------------------------------------------

// internal enum SimpleAlignment :2048
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/Caching/$.uno(849)
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(2518)
// --------------------------------------------------------------

// private sealed class TranslationModes.SizeFactorMode :2518
// {
...
// public generated SizeFactorMode New() :2518
...
// public generated SizeFactorMode() [instance] :2518
void TranslationModes__SizeFactorMode::ctor_()
{
}

// public Fuse.TransformModeFlags get_Flags() [instance] :2534
...
// public float3 GetScaleVector(Fuse.Scaling t) [instance] :2520
...
// public generated SizeFactorMode New() [static] :2518
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(2062)
// --------------------------------------------------------------

// public enum SizeUnit :2062
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(332)
// -------------------------------------------------------------

// internal class StandardBoxSizing :332
// {
// static StandardBoxSizing() :332
...
// public generated StandardBoxSizing() :332
void StandardBoxSizing__ctor_1_fn(StandardBoxSizing* __this)
{
    __this->ctor_1();
}

// public override sealed float2 CalcArrangePaddingSize(Fuse.Elements.Element element, Fuse.LayoutParams lp) :440
...
// public override sealed Fuse.Elements.BoxPlacement CalcBoxPlacement(Fuse.Elements.Element element, float2 position, Fuse.LayoutParams lp) :336
...
// public override sealed float2 CalcMarginSize(Fuse.Elements.Element element, Fuse.LayoutParams lp) :422
...
// public override sealed Fuse.LayoutDependent IsContentRelativeSize(Fuse.Elements.Element element) :475
...
// public generated StandardBoxSizing New() :332
void StandardBoxSizing__New1_fn(StandardBoxSizing** __retval)
{
    *__retval = StandardBoxSizing::New1();
}

// private float2 SnapUp(Fuse.Elements.Element element, float2 p) :469
...
// public generated StandardBoxSizing() [instance] :332
...
// private float2 SnapUp(Fuse.Elements.Element element, float2 p) [instance] :469
...
// public generated StandardBoxSizing New() [static] :332
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(2080)
// --------------------------------------------------------------

// public enum StretchDirection :2080
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(2069)
// --------------------------------------------------------------

// public enum StretchMode :2069
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(2087)
// --------------------------------------------------------------

// public enum StretchSizing :2087
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(1964)
// --------------------------------------------------------------

// public enum TextAlignment :1964
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/Caching/$.uno(1509)
// ----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(1958)
// --------------------------------------------------------------

// public enum TextWrapping :1958
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(1744)
// --------------------------------------------------------------

// private sealed class TransformOrigins.TopLeftOrigin :1744
// {
...
// public generated TopLeftOrigin() :1744
void TransformOrigins__TopLeftOrigin__ctor__fn(TransformOrigins__TopLeftOrigin* __this)
{
    __this->ctor_();
}

// public float3 GetOffset(Fuse.Elements.Element elm) :1746
...
// public generated TopLeftOrigin New() :1744
...
// public generated TopLeftOrigin() [instance] :1744
void TransformOrigins__TopLeftOrigin::ctor_()
{
}

// public float3 GetOffset(Fuse.Elements.Element elm) [instance] :1746
...
// public generated TopLeftOrigin New() [static] :1744
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(2500)
// --------------------------------------------------------------

// private sealed class TranslationModes.TransformOriginOffsetMode :2500
// {
...
// public generated TransformOriginOffsetMode() :2500
void TranslationModes__TransformOriginOffsetMode__ctor_1_fn(TranslationModes__TransformOriginOffsetMode* __this)
{
    __this->ctor_1();
}

// protected override sealed float3 GetDstOffset(Fuse.Elements.Element e) :2502
void TranslationModes__TransformOriginOffsetMode__GetDstOffset_fn(TranslationModes__TransformOriginOffsetMode* __this, ::g::Fuse::Elements::Element* e, ::g::Uno::Float3* __retval)
{
    ...
    return *__retval = ::g::Fuse::Elements::ITransformOrigin::GetOffset(uInterface(uPtr(uPtr(e)->TransformOrigin()), ::TYPES[106/*Fuse.Elements.ITransformOrigin*/]), e), void();
}

// protected override sealed float3 GetSrcOffset(Fuse.Elements.Element e) :2507
...
// public generated TransformOriginOffsetMode New() :2500
...
// public generated TransformOriginOffsetMode() [instance] :2500
...
// public generated TransformOriginOffsetMode New() [static] :2500
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(1742)
// --------------------------------------------------------------

// public static class TransformOrigins :1742
// {
// static TransformOrigins() :1742
...
uClassType* TransformOrigins_typeof()
{
    ...
    ::TYPES[106] = ::g::Fuse::Elements::ITransformOrigin_typeof();
    ::TYPES[107] = TransformOrigins__BoxCenter_typeof();
    type->SetFields(0,
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(2464)
// --------------------------------------------------------------

// public static class TranslationModes :2464
// {
// static TranslationModes() :2464
...
// /usr/local/share/uno/Packages/Fuse.Controls/0.23.2/$.uno(4896)
// --------------------------------------------------------------

// public sealed class Viewport :4896
// {
...
// public Viewport() :4898
void Viewport__ctor_2_fn(Viewport* __this)
{
    __this->ctor_2();
}

// protected override sealed void ArrangePaddingBox(Fuse.LayoutParams lp) :5035
...
// public override sealed Fuse.Node GetSubNode(int index) :5049
...
// private bool get_HasCullFace() :4916
void Viewport__get_HasCullFace_fn(Viewport* __this, bool* __retval)
{
    *__retval = __this->HasCullFace();
}

// public override sealed Fuse.NodeBounds get_HitTestBounds() :5088
...
// private generated void init_DrawCalls() :4896
void Viewport__init_DrawCalls_fn(Viewport* __this)
{
    __this->init_DrawCalls();
}

// public Viewport New() :4898
void Viewport__New1_fn(Viewport** __retval)
{
    *__retval = Viewport::New1();
}

// protected override sealed void OnDraw(Fuse.DrawContext dc) :4987
void Viewport__OnDraw_fn(Viewport* __this, ::g::Fuse::DrawContext* dc)
{
    ...
    if (__this->Flatten())
    {
        ...
        __this->_draw_79d7a860.Uniform12(1, ::g::Fuse::IViewport::ViewProjectionTransform(uInterface(uPtr(dc->Viewport()), ::TYPES[25/*Fuse.IViewport*/])));
...
// protected override sealed void OnHitTestChildren(Fuse.HitTestContext htc) :5054
...
// public float4x4 get_ViewProjectionTransformInverse() :5072
...
// public Uno.Graphics.PolygonFace get_CullFace() [instance] :4907
...
// public void set_CullFace(Uno.Graphics.PolygonFace value) [instance] :4908
...
// public bool get_Flatten() [instance] :4979
...
// public void set_Flatten(bool value) [instance] :4980
...
// private Fuse.IFrustum get_Frustum() [instance] :4945
...
// private void set_Frustum(Fuse.IFrustum value) [instance] :4946
...
// private bool get_HasCullFace() [instance] :4916
...
// private generated void init_DrawCalls() [instance] :4896
void Viewport::init_DrawCalls()
{
    uStackFrame __("Fuse.Elements.Viewport", "init_DrawCalls()");
    OnDraw_VertexData_79d7a860_7_2_1 = ::g::Uno::Graphics::VertexBuffer::New2(::g::Uno::Runtime::Implementation::Internal::BufferConverters::ToBuffer3(uArray::Init< ::g::Uno::Float2>(::TYPES[26/*float2[]*/], 6, ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(0.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 0.0f))), 0);
...
// public float get_Perspective() [instance] :4957
...
// public void set_Perspective(float value) [instance] :4958
...
// public float2 get_PixelSize() [instance] :5063
...
// public float get_PointDensity() [instance] :5061
float Viewport::PointDensity()
{
    uStackFrame __("Fuse.Elements.Viewport", "get_PointDensity()");
    return ::g::Fuse::IViewport::PointDensity(uInterface(uPtr(uPtr(Parent())->Viewport()), ::TYPES[25/*Fuse.IViewport*/]));
}

// public Uno.Geometry.Ray PointToWorldRay(float2 pointPos) [instance] :5080
...
// public float4x4 get_ProjectionTransform() [instance] :5066
...
// public float4x4 get_ProjectionTransformInverse() [instance] :5068
...
// public Fuse.Node get_RootNode() [instance] :4928
...
// public void set_RootNode(Fuse.Node value) [instance] :4929
...
// public float2 get_Size() [instance] :5062
...
// private void UpdateFrustum() [instance] :4919
...
// public float3 get_ViewOrigin() [instance] :5078
::g::Uno::Float3 Viewport::ViewOrigin()
{
    uStackFrame __("Fuse.Elements.Viewport", "get_ViewOrigin()");
    return ::g::Fuse::IFrustum::GetWorldPosition(uInterface(uPtr(Frustum()), ::TYPES[21/*Fuse.IFrustum*/]), (uObject*)this);
}

// public float4x4 get_ViewProjectionTransform() [instance] :5070
...
// public float4x4 get_ViewProjectionTransformInverse() [instance] :5072
...
// public float2 get_ViewRange() [instance] :5079
::g::Uno::Float2 Viewport::ViewRange()
{
    uStackFrame __("Fuse.Elements.Viewport", "get_ViewRange()");
    return ::g::Fuse::IFrustum::GetDepthRange(uInterface(uPtr(Frustum()), ::TYPES[21/*Fuse.IFrustum*/]), (uObject*)this);
}

// public float4x4 get_ViewTransform() [instance] :5074
...
// public float4x4 get_ViewTransformInverse() [instance] :5076
...
// public Viewport New() [static] :4898
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.23.2/$.uno(1971)
// --------------------------------------------------------------

// public enum Visibility :1971
