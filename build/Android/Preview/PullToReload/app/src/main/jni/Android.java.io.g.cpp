...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/java/io/$.uno(3712)
// ------------------------------------------------------------------------
...
{
    uStackFrame __("Android.java.io.FileDescriptor", "toString()");
...
{
    uStackFrame __("Android.java.io.FileDescriptor", "_Init()");
...
{
    uStackFrame __("Android.java.io.FileDescriptor", "toString_IMPL_29625(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/java/io/$.uno(534)
// -----------------------------------------------------------------------
...
{
    uStackFrame __("Android.java.io.InputStream", "close()");
...
{
    uStackFrame __("Android.java.io.InputStream", "_Init()");
...
{
    uStackFrame __("Android.java.io.InputStream", "close_IMPL_29700(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
