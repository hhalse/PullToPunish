...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/os/$.uno(2666)
// ---------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/os/$.uno(2167)
// ---------------------------------------------------------------------------
...
{
    uStackFrame __("Android.android.os.BuildDLRVERSION", "_Init()");
...
{
    uStackFrame __("Android.android.os.BuildDLRVERSION", "get_SDK_INT()");
    INIT_JNI;
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/os/$.uno(3069)
// ---------------------------------------------------------------------------
...
// public int describeContents() :3665
void Bundle__describeContents_fn(Bundle* __this, int* __retval)
{
    *__retval = __this->describeContents();
}

// public static extern int describeContents_IMPL_13584(bool arg0, Android.Base.Primitives.ujobject arg1) :3940
...
// public void writeToParcel(Android.android.os.Parcel arg0, int arg1) :3671
void Bundle__writeToParcel_fn(Bundle* __this, ::g::Android::android::os::Parcel* arg0, int* arg1)
{
    __this->writeToParcel(arg0, *arg1);
}

// public static extern void writeToParcel_IMPL_13585(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2, int arg3) :3943
...
// public int describeContents() [instance] :3665
int Bundle::describeContents()
{
    uStackFrame __("Android.android.os.Bundle", "describeContents()");
    return Bundle::describeContents_IMPL_13584(_subclassed, _javaObject);
}

// public void writeToParcel(Android.android.os.Parcel arg0, int arg1) [instance] :3671
void Bundle::writeToParcel(::g::Android::android::os::Parcel* arg0, int arg1)
{
    uStackFrame __("Android.android.os.Bundle", "writeToParcel(Android.android.os.Parcel,int)");
    int arg1_ = arg1;
...
// public static extern int describeContents_IMPL_13584(bool arg0, Android.Base.Primitives.ujobject arg1) [static] :3940
int Bundle::describeContents_IMPL_13584(bool arg0_, jobject arg1_)
{
    uStackFrame __("Android.android.os.Bundle", "describeContents_IMPL_13584(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
...
// public static extern void writeToParcel_IMPL_13585(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2, int arg3) [static] :3943
void Bundle::writeToParcel_IMPL_13585(bool arg0_, jobject arg1_, uObject* arg2_, int arg3_)
{
    uStackFrame __("Android.android.os.Bundle", "writeToParcel_IMPL_13585(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper,int)");
    INIT_JNI;
    CLASS_INIT(Bundle::_javaClass2(),Bundle::_Init2());
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/os/$.uno(11)
// -------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/os/$.uno(11379)
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/os/$.uno(11362)
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/os/$.uno(11440)
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/os/$.uno(6368)
// ---------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/os/$.uno(6616)
// ---------------------------------------------------------------------------
...
// public int describeContents() :6895
void Message__describeContents_fn(Message* __this, int* __retval)
{
    *__retval = __this->describeContents();
}

// public static extern int describeContents_IMPL_13886(bool arg0, Android.Base.Primitives.ujobject arg1) :6966
...
// public void writeToParcel(Android.android.os.Parcel arg0, int arg1) :6901
void Message__writeToParcel_fn(Message* __this, ::g::Android::android::os::Parcel* arg0, int* arg11)
{
    __this->writeToParcel(arg0, *arg11);
}

// public static extern void writeToParcel_IMPL_13887(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2, int arg3) :6969
...
// public int describeContents() [instance] :6895
int Message::describeContents()
{
    uStackFrame __("Android.android.os.Message", "describeContents()");
    return Message::describeContents_IMPL_13886(_subclassed, _javaObject);
}

// public void writeToParcel(Android.android.os.Parcel arg0, int arg1) [instance] :6901
void Message::writeToParcel(::g::Android::android::os::Parcel* arg0, int arg11)
{
    uStackFrame __("Android.android.os.Message", "writeToParcel(Android.android.os.Parcel,int)");
    int arg11_ = arg11;
...
// public static extern int describeContents_IMPL_13886(bool arg0, Android.Base.Primitives.ujobject arg1) [static] :6966
int Message::describeContents_IMPL_13886(bool arg0_, jobject arg1_)
{
    uStackFrame __("Android.android.os.Message", "describeContents_IMPL_13886(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
...
// public static extern void writeToParcel_IMPL_13887(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2, int arg3) [static] :6969
void Message::writeToParcel_IMPL_13887(bool arg0_, jobject arg1_, uObject* arg2_, int arg3_)
{
    uStackFrame __("Android.android.os.Message", "writeToParcel_IMPL_13887(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper,int)");
    INIT_JNI;
    CLASS_INIT(Message::_javaClass2(),Message::_Init2());
    jobject _obArg2 = ((!arg2_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg2_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/os/$.uno(7269)
// ---------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/os/$.uno(11299)
// ----------------------------------------------------------------------------

// public abstract extern interface Parcelable :11299
// {
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/os/$.uno(1038)
// ---------------------------------------------------------------------------
