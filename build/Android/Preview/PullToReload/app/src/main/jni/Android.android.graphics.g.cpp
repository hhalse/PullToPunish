...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/graphics/$.uno(2162)
// ---------------------------------------------------------------------------------
...
// public int describeContents() :2492
void Bitmap__describeContents_fn(Bitmap* __this, int* __retval)
{
    *__retval = __this->describeContents();
}

// public static extern int describeContents_IMPL_6487(bool arg0, Android.Base.Primitives.ujobject arg1) :2673
...
// public void writeToParcel(Android.android.os.Parcel arg0, int arg1) :2498
void Bitmap__writeToParcel_fn(Bitmap* __this, ::g::Android::android::os::Parcel* arg0, int* arg1)
{
    __this->writeToParcel(arg0, *arg1);
}

// public static extern void writeToParcel_IMPL_6488(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2, int arg3) :2676
...
// public int describeContents() [instance] :2492
int Bitmap::describeContents()
{
    uStackFrame __("Android.android.graphics.Bitmap", "describeContents()");
...
{
    uStackFrame __("Android.android.graphics.Bitmap", "eraseColor(int)");
    int arg0_ = arg0;
...
void Bitmap::recycle()
{
    uStackFrame __("Android.android.graphics.Bitmap", "recycle()");
...
{
    uStackFrame __("Android.android.graphics.Bitmap", "setHasMipMap(bool)");
    bool arg0_ = arg0;
    Bitmap::setHasMipMap_IMPL_6481(_subclassed, _javaObject, arg0_);
}

// public void writeToParcel(Android.android.os.Parcel arg0, int arg1) [instance] :2498
void Bitmap::writeToParcel(::g::Android::android::os::Parcel* arg0, int arg1)
{
    uStackFrame __("Android.android.graphics.Bitmap", "writeToParcel(Android.android.os.Parcel,int)");
    int arg1_ = arg1;
...
void Bitmap::_Init2()
{
    uStackFrame __("Android.android.graphics.Bitmap", "_Init()");
...
{
    uStackFrame __("Android.android.graphics.Bitmap", "createBitmap(int,int,Android.android.graphics.BitmapDLRConfig)");
...
{
    uStackFrame __("Android.android.graphics.Bitmap", "createBitmap_IMPL_6455(int,int,Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
...
// public static extern int describeContents_IMPL_6487(bool arg0, Android.Base.Primitives.ujobject arg1) [static] :2673
int Bitmap::describeContents_IMPL_6487(bool arg0_, jobject arg1_)
{
    uStackFrame __("Android.android.graphics.Bitmap", "describeContents_IMPL_6487(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
    CLASS_INIT(Bitmap::_javaClass2(),Bitmap::_Init2());
...
{
    uStackFrame __("Android.android.graphics.Bitmap", "eraseColor_IMPL_6482(bool,Android.Base.Primitives.ujobject,int)");
    INIT_JNI;
    CLASS_INIT(Bitmap::_javaClass2(),Bitmap::_Init2());
...
{
    uStackFrame __("Android.android.graphics.Bitmap", "recycle_IMPL_6445(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
    CLASS_INIT(Bitmap::_javaClass2(),Bitmap::_Init2());
...
{
    uStackFrame __("Android.android.graphics.Bitmap", "setHasMipMap_IMPL_6481(bool,Android.Base.Primitives.ujobject,bool)");
    INIT_JNI;
    CLASS_INIT(Bitmap::_javaClass2(),Bitmap::_Init2());
...
// public static extern void writeToParcel_IMPL_6488(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2, int arg3) [static] :2676
void Bitmap::writeToParcel_IMPL_6488(bool arg0_, jobject arg1_, uObject* arg2_, int arg3_)
{
    uStackFrame __("Android.android.graphics.Bitmap", "writeToParcel_IMPL_6488(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper,int)");
    INIT_JNI;
    CLASS_INIT(Bitmap::_javaClass2(),Bitmap::_Init2());
    jobject _obArg2 = ((!arg2_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg2_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/graphics/$.uno(174)
// --------------------------------------------------------------------------------
...
{
    uStackFrame __("Android.android.graphics.BitmapDLRConfig", "_Init()");
...
{
    uStackFrame __("Android.android.graphics.BitmapDLRConfig", "get_ARGB_8888()");
    INIT_JNI;
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/graphics/$.uno(3225)
// ---------------------------------------------------------------------------------
...
{
    uStackFrame __("Android.android.graphics.BitmapFactory", "_Init()");
...
{
    uStackFrame __("Android.android.graphics.BitmapFactory", "decodeFile(Android.java.lang.String)");
...
{
    uStackFrame __("Android.android.graphics.BitmapFactory", "decodeFile_IMPL_6516(Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
...
{
    uStackFrame __("Android.android.graphics.BitmapFactory", "decodeStream(Android.java.io.InputStream)");
...
{
    uStackFrame __("Android.android.graphics.BitmapFactory", "decodeStream_IMPL_6523(Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
    CLASS_INIT(BitmapFactory::_javaClass2(),BitmapFactory::_Init2());
    jobject _obArg0 = ((!arg0_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg0_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
    uObject* result;
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/graphics/$.uno(3832)
// ---------------------------------------------------------------------------------
...
{
    uStackFrame __("Android.android.graphics.Canvas", ".ctor(Android.android.graphics.Bitmap)");
...
{
    uStackFrame __("Android.android.graphics.Canvas", "translate(float,float)");
    float arg0_ = arg0;
    float arg1_ = arg1;
...
void Canvas::_Init2()
{
    uStackFrame __("Android.android.graphics.Canvas", "_Init()");
...
{
    uStackFrame __("Android.android.graphics.Canvas", "translate_IMPL_6596(bool,Android.Base.Primitives.ujobject,float,float)");
    INIT_JNI;
    CLASS_INIT(Canvas::_javaClass2(),Canvas::_Init2());
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/graphics/$.uno(4744)
// ---------------------------------------------------------------------------------
...
void Color::_Init2()
{
    uStackFrame __("Android.android.graphics.Color", "_Init()");
...
{
    uStackFrame __("Android.android.graphics.Color", "argb(int,int,int,int)");
...
{
    uStackFrame __("Android.android.graphics.Color", "argb_IMPL_6680(int,int,int,int)");
    INIT_JNI;
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/graphics/$.uno(6167)
// ---------------------------------------------------------------------------------

// public sealed extern class LinearGradient :6167
// {
...
// public LinearGradient(float arg0, float arg1, float arg2, float arg3, Android.Runtime.IntArray arg4, Android.Runtime.FloatArray arg5, Android.android.graphics.ShaderDLRTileMode arg6) :6174
void LinearGradient__ctor_8_fn(LinearGradient* __this, float* arg0, float* arg1, float* arg2, float* arg3, ::g::Android::Runtime::IntArray* arg4, ::g::Android::Runtime::FloatArray* arg5, ::g::Android::android::graphics::ShaderDLRTileMode* arg6)
{
    __this->ctor_8(*arg0, *arg1, *arg2, *arg3, arg4, arg5, arg6);
}

// public static extern new void _Init() :6171
void LinearGradient___Init3_fn()
{
    LinearGradient::_Init3();
}

// public LinearGradient New(float arg0, float arg1, float arg2, float arg3, Android.Runtime.IntArray arg4, Android.Runtime.FloatArray arg5, Android.android.graphics.ShaderDLRTileMode arg6) :6174
...
// public LinearGradient(float arg0, float arg1, float arg2, float arg3, Android.Runtime.IntArray arg4, Android.Runtime.FloatArray arg5, Android.android.graphics.ShaderDLRTileMode arg6) [instance] :6174
void LinearGradient::ctor_8(float arg0, float arg1, float arg2, float arg3, ::g::Android::Runtime::IntArray* arg4, ::g::Android::Runtime::FloatArray* arg5, ::g::Android::android::graphics::ShaderDLRTileMode* arg6)
{
    uStackFrame __("Android.android.graphics.LinearGradient", ".ctor(float,float,float,float,Android.Runtime.IntArray,Android.Runtime.FloatArray,Android.android.graphics.ShaderDLRTileMode)");
...
// public static extern new void _Init() [static] :6171
void LinearGradient::_Init3()
{
    uStackFrame __("Android.android.graphics.LinearGradient", "_Init()");
...
// public LinearGradient New(float arg0, float arg1, float arg2, float arg3, Android.Runtime.IntArray arg4, Android.Runtime.FloatArray arg5, Android.android.graphics.ShaderDLRTileMode arg6) [static] :6174
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/graphics/$.uno(6224)
// ---------------------------------------------------------------------------------
...
// public override sealed bool equals(Android.java.lang.Object arg0) :6433
void Matrix__equals1_fn(Matrix* __this, ::g::Android::java::lang::Object* arg0, bool* __retval)
{
    uStackFrame __("Android.android.graphics.Matrix", "equals(Android.java.lang.Object)");
    return *__retval = Matrix::equals_IMPL_6769(__this->_subclassed, __this->_javaObject, (uObject*)arg0), void();
}

// public static extern bool equals_IMPL_6769(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2) :6721
...
{
    uStackFrame __("Android.android.graphics.Matrix", "hashCode()");
...
{
    uStackFrame __("Android.android.graphics.Matrix", "toString()");
...
void Matrix::ctor_5()
{
    uStackFrame __("Android.android.graphics.Matrix", ".ctor()");
    ctor_4(::g::Android::Base::JNI::GetDefaultObject(), ::g::Android::Base::JNI::GetDefaultType(), false, false);
    INIT_JNI;;
...
{
    uStackFrame __("Android.android.graphics.Matrix", "setValues(Android.Runtime.FloatArray)");
...
void Matrix::_Init2()
{
    uStackFrame __("Android.android.graphics.Matrix", "_Init()");
...
// public static extern bool equals_IMPL_6769(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2) [static] :6721
bool Matrix::equals_IMPL_6769(bool arg0_, jobject arg1_, uObject* arg2_)
{
    uStackFrame __("Android.android.graphics.Matrix", "equals_IMPL_6769(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
    CLASS_INIT(Matrix::_javaClass2(),Matrix::_Init2());
    jobject _obArg2 = ((!arg2_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg2_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
    bool result;
...
{
    uStackFrame __("Android.android.graphics.Matrix", "hashCode_IMPL_6770(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
    CLASS_INIT(Matrix::_javaClass2(),Matrix::_Init2());
...
{
    uStackFrame __("Android.android.graphics.Matrix", "setValues_IMPL_6811(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
    CLASS_INIT(Matrix::_javaClass2(),Matrix::_Init2());
    jobject _obArg2 = ((!arg2_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg2_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
...
{
    uStackFrame __("Android.android.graphics.Matrix", "toString_IMPL_6812(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
    CLASS_INIT(Matrix::_javaClass2(),Matrix::_Init2());
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/graphics/$.uno(7509)
// ---------------------------------------------------------------------------------
...
{
    uStackFrame __("Android.android.graphics.Paint", ".ctor(Android.Base.Primitives.ujobject,Uno.Type,bool,bool)");
...
{
    uStackFrame __("Android.android.graphics.Paint", "getTextBounds(Android.java.lang.String,int,int,Android.android.graphics.Rect)");
    int arg1_ = arg1;
    int arg2_ = arg2;
...
{
    uStackFrame __("Android.android.graphics.Paint", "setAntiAlias(bool)");
    bool arg0_ = arg0;
...
{
    uStackFrame __("Android.android.graphics.Paint", "setARGB(int,int,int,int)");
    int arg0_ = arg0;
    int arg1_ = arg1;
    int arg2_ = arg2;
    int arg3_ = arg3;
...
{
    uStackFrame __("Android.android.graphics.Paint", "setColor(int)");
    int arg0_ = arg0;
...
{
    uStackFrame __("Android.android.graphics.Paint", "setStrokeWidth(float)");
    float arg0_ = arg0;
...
{
    uStackFrame __("Android.android.graphics.Paint", "setStyle(Android.android.graphics.PaintDLRStyle)");
...
{
    uStackFrame __("Android.android.graphics.Paint", "setTextSize(float)");
    float arg0_ = arg0;
...
{
    uStackFrame __("Android.android.graphics.Paint", "setTypeface(Android.android.graphics.Typeface)");
...
void Paint::_Init2()
{
    uStackFrame __("Android.android.graphics.Paint", "_Init()");
...
{
    uStackFrame __("Android.android.graphics.Paint", "getTextBounds_IMPL_6975(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper,int,int,Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
...
{
    uStackFrame __("Android.android.graphics.Paint", "setAntiAlias_IMPL_6898(bool,Android.Base.Primitives.ujobject,bool)");
    INIT_JNI;
    CLASS_INIT(Paint::_javaClass2(),Paint::_Init2());
...
{
    uStackFrame __("Android.android.graphics.Paint", "setARGB_IMPL_6919(bool,Android.Base.Primitives.ujobject,int,int,int,int)");
    INIT_JNI;
    CLASS_INIT(Paint::_javaClass2(),Paint::_Init2());
...
{
    uStackFrame __("Android.android.graphics.Paint", "setColor_IMPL_6916(bool,Android.Base.Primitives.ujobject,int)");
    INIT_JNI;
    CLASS_INIT(Paint::_javaClass2(),Paint::_Init2());
...
{
    uStackFrame __("Android.android.graphics.Paint", "setStrokeWidth_IMPL_6921(bool,Android.Base.Primitives.ujobject,float)");
    INIT_JNI;
    CLASS_INIT(Paint::_javaClass2(),Paint::_Init2());
...
{
    uStackFrame __("Android.android.graphics.Paint", "setStyle_IMPL_6914(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
    CLASS_INIT(Paint::_javaClass2(),Paint::_Init2());
    jobject _obArg2 = ((!arg2_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg2_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
...
{
    uStackFrame __("Android.android.graphics.Paint", "setTextSize_IMPL_6950(bool,Android.Base.Primitives.ujobject,float)");
    INIT_JNI;
    CLASS_INIT(Paint::_javaClass2(),Paint::_Init2());
...
{
    uStackFrame __("Android.android.graphics.Paint", "setTypeface_IMPL_6940(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
    CLASS_INIT(Paint::_javaClass2(),Paint::_Init2());
    jobject _obArg2 = ((!arg2_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg2_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
    uObject* result;
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/graphics/$.uno(1018)
// ---------------------------------------------------------------------------------
...
{
    uStackFrame __("Android.android.graphics.PaintDLRStyle", "_Init()");
...
{
    uStackFrame __("Android.android.graphics.PaintDLRStyle", "get_STROKE()");
    INIT_JNI;
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/graphics/$.uno(9790)
// ---------------------------------------------------------------------------------

// public sealed extern class Point :9790
// {
...
// public static extern new void _Init() :9794
void Point___Init2_fn()
{
    Point::_Init2();
}

// public int describeContents() :9953
void Point__describeContents_fn(Point* __this, int* __retval)
{
    *__retval = __this->describeContents();
}

// public static extern int describeContents_IMPL_7105(bool arg0, Android.Base.Primitives.ujobject arg1) :9996
...
// public override sealed bool equals(Android.java.lang.Object arg0) :9935
void Point__equals1_fn(Point* __this, ::g::Android::java::lang::Object* arg0, bool* __retval)
{
    uStackFrame __("Android.android.graphics.Point", "equals(Android.java.lang.Object)");
    return *__retval = Point::equals_IMPL_7102(__this->_subclassed, __this->_javaObject, (uObject*)arg0), void();
}

// public static extern bool equals_IMPL_7102(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2) :9987
...
// public static extern Android.Base.Wrappers.IJWrapper toString_IMPL_7104(bool arg0, Android.Base.Primitives.ujobject arg1) :9993
void Point__toString_IMPL_7104_fn(bool* arg0_, jobject* arg1_, uObject** __retval)
{
    *__retval = Point::toString_IMPL_7104(*arg0_, *arg1_);
}

// public void writeToParcel(Android.android.os.Parcel arg0, int arg1) :9959
void Point__writeToParcel_fn(Point* __this, ::g::Android::android::os::Parcel* arg0, int* arg1)
{
    __this->writeToParcel(arg0, *arg1);
}

// public static extern void writeToParcel_IMPL_7106(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2, int arg3) :9999
...
// public int describeContents() [instance] :9953
int Point::describeContents()
{
    uStackFrame __("Android.android.graphics.Point", "describeContents()");
    return Point::describeContents_IMPL_7105(_subclassed, _javaObject);
}

// public void writeToParcel(Android.android.os.Parcel arg0, int arg1) [instance] :9959
void Point::writeToParcel(::g::Android::android::os::Parcel* arg0, int arg1)
{
    uStackFrame __("Android.android.graphics.Point", "writeToParcel(Android.android.os.Parcel,int)");
    int arg1_ = arg1;
    Point::writeToParcel_IMPL_7106(_subclassed, _javaObject, (uObject*)arg0, arg1_);
}

// public static extern new void _Init() [static] :9794
void Point::_Init2()
{
    uStackFrame __("Android.android.graphics.Point", "_Init()");
...
// public static extern int describeContents_IMPL_7105(bool arg0, Android.Base.Primitives.ujobject arg1) [static] :9996
int Point::describeContents_IMPL_7105(bool arg0_, jobject arg1_)
{
    uStackFrame __("Android.android.graphics.Point", "describeContents_IMPL_7105(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
...
// public static extern bool equals_IMPL_7102(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2) [static] :9987
bool Point::equals_IMPL_7102(bool arg0_, jobject arg1_, uObject* arg2_)
{
    uStackFrame __("Android.android.graphics.Point", "equals_IMPL_7102(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
    CLASS_INIT(Point::_javaClass2(),Point::_Init2());
    jobject _obArg2 = ((!arg2_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg2_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
    bool result;
...
// public static extern int hashCode_IMPL_7103(bool arg0, Android.Base.Primitives.ujobject arg1) [static] :9990
int Point::hashCode_IMPL_7103(bool arg0_, jobject arg1_)
{
    uStackFrame __("Android.android.graphics.Point", "hashCode_IMPL_7103(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
    CLASS_INIT(Point::_javaClass2(),Point::_Init2());
...
// public static extern Android.Base.Wrappers.IJWrapper toString_IMPL_7104(bool arg0, Android.Base.Primitives.ujobject arg1) [static] :9993
uObject* Point::toString_IMPL_7104(bool arg0_, jobject arg1_)
{
    uStackFrame __("Android.android.graphics.Point", "toString_IMPL_7104(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
    CLASS_INIT(Point::_javaClass2(),Point::_Init2());
...
// public static extern void writeToParcel_IMPL_7106(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2, int arg3) [static] :9999
void Point::writeToParcel_IMPL_7106(bool arg0_, jobject arg1_, uObject* arg2_, int arg3_)
{
    uStackFrame __("Android.android.graphics.Point", "writeToParcel_IMPL_7106(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper,int)");
    INIT_JNI;
    CLASS_INIT(Point::_javaClass2(),Point::_Init2());
    jobject _obArg2 = ((!arg2_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg2_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/graphics/$.uno(1502)
// ---------------------------------------------------------------------------------
...
{
    uStackFrame __("Android.android.graphics.PorterDuffDLRMode", "_Init()");
...
{
    uStackFrame __("Android.android.graphics.PorterDuffDLRMode", "get_SRC_IN()");
    INIT_JNI;
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/graphics/$.uno(10443)
// ----------------------------------------------------------------------------------
...
// public int describeContents() :10800
void Rect__describeContents_fn(Rect* __this, int* __retval)
{
    *__retval = __this->describeContents();
}

// public static extern int describeContents_IMPL_7193(bool arg0, Android.Base.Primitives.ujobject arg1) :10915
...
// public override sealed bool equals(Android.java.lang.Object arg0) :10614
void Rect__equals1_fn(Rect* __this, ::g::Android::java::lang::Object* arg0, bool* __retval)
{
    uStackFrame __("Android.android.graphics.Rect", "equals(Android.java.lang.Object)");
    return *__retval = Rect::equals_IMPL_7162(__this->_subclassed, __this->_javaObject, (uObject*)arg0), void();
}

// public static extern bool equals_IMPL_7162(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2) :10822
...
{
    uStackFrame __("Android.android.graphics.Rect", "hashCode()");
...
{
    uStackFrame __("Android.android.graphics.Rect", "toString()");
...
// public void writeToParcel(Android.android.os.Parcel arg0, int arg1) :10806
void Rect__writeToParcel_fn(Rect* __this, ::g::Android::android::os::Parcel* arg0, int* arg1)
{
    __this->writeToParcel(arg0, *arg1);
}

// public static extern void writeToParcel_IMPL_7194(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2, int arg3) :10918
...
void Rect::ctor_5()
{
    uStackFrame __("Android.android.graphics.Rect", ".ctor()");
    ctor_4(::g::Android::Base::JNI::GetDefaultObject(), ::g::Android::Base::JNI::GetDefaultType(), false, false);
    INIT_JNI;;
...
int Rect::bottom()
{
    uStackFrame __("Android.android.graphics.Rect", "get_bottom()");
    INIT_JNI;
...
{
    uStackFrame __("Android.android.graphics.Rect", "set_bottom(int)");
    INIT_JNI;
    if (::uEnterCriticalIfNull(&Rect::bottom_7157_ID())) {;
    CACHE_FIELD(Rect::bottom_7157_ID(),Rect::_javaClass2(),"bottom","I",GetFieldID,"Id for field Rect.bottom could not be cached",44);
    ::uExitCritical();;
...
// public int describeContents() [instance] :10800
int Rect::describeContents()
{
    uStackFrame __("Android.android.graphics.Rect", "describeContents()");
...
int Rect::left()
{
    uStackFrame __("Android.android.graphics.Rect", "get_left()");
    INIT_JNI;
...
{
    uStackFrame __("Android.android.graphics.Rect", "set_left(int)");
    INIT_JNI;
    if (::uEnterCriticalIfNull(&Rect::left_7154_ID())) {;
    CACHE_FIELD(Rect::left_7154_ID(),Rect::_javaClass2(),"left","I",GetFieldID,"Id for field Rect.left could not be cached",42);
    ::uExitCritical();;
...
int Rect::right()
{
    uStackFrame __("Android.android.graphics.Rect", "get_right()");
    INIT_JNI;
...
{
    uStackFrame __("Android.android.graphics.Rect", "set_right(int)");
    INIT_JNI;
    if (::uEnterCriticalIfNull(&Rect::right_7156_ID())) {;
    CACHE_FIELD(Rect::right_7156_ID(),Rect::_javaClass2(),"right","I",GetFieldID,"Id for field Rect.right could not be cached",43);
    ::uExitCritical();;
...
int Rect::top()
{
    uStackFrame __("Android.android.graphics.Rect", "get_top()");
    INIT_JNI;
...
{
    uStackFrame __("Android.android.graphics.Rect", "set_top(int)");
    INIT_JNI;
    if (::uEnterCriticalIfNull(&Rect::top_7155_ID())) {;
    CACHE_FIELD(Rect::top_7155_ID(),Rect::_javaClass2(),"top","I",GetFieldID,"Id for field Rect.top could not be cached",41);
    ::uExitCritical();;
...
// public void writeToParcel(Android.android.os.Parcel arg0, int arg1) [instance] :10806
void Rect::writeToParcel(::g::Android::android::os::Parcel* arg0, int arg1)
{
    uStackFrame __("Android.android.graphics.Rect", "writeToParcel(Android.android.os.Parcel,int)");
    int arg1_ = arg1;
...
void Rect::_Init2()
{
    uStackFrame __("Android.android.graphics.Rect", "_Init()");
...
// public static extern int describeContents_IMPL_7193(bool arg0, Android.Base.Primitives.ujobject arg1) [static] :10915
int Rect::describeContents_IMPL_7193(bool arg0_, jobject arg1_)
{
    uStackFrame __("Android.android.graphics.Rect", "describeContents_IMPL_7193(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
    CLASS_INIT(Rect::_javaClass2(),Rect::_Init2());
...
// public static extern bool equals_IMPL_7162(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2) [static] :10822
bool Rect::equals_IMPL_7162(bool arg0_, jobject arg1_, uObject* arg2_)
{
    uStackFrame __("Android.android.graphics.Rect", "equals_IMPL_7162(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
    CLASS_INIT(Rect::_javaClass2(),Rect::_Init2());
    jobject _obArg2 = ((!arg2_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg2_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
    bool result;
...
{
    uStackFrame __("Android.android.graphics.Rect", "hashCode_IMPL_7163(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
    CLASS_INIT(Rect::_javaClass2(),Rect::_Init2());
...
{
    uStackFrame __("Android.android.graphics.Rect", "toString_IMPL_7164(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
    CLASS_INIT(Rect::_javaClass2(),Rect::_Init2());
...
// public static extern void writeToParcel_IMPL_7194(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2, int arg3) [static] :10918
void Rect::writeToParcel_IMPL_7194(bool arg0_, jobject arg1_, uObject* arg2_, int arg3_)
{
    uStackFrame __("Android.android.graphics.Rect", "writeToParcel_IMPL_7194(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper,int)");
    INIT_JNI;
    CLASS_INIT(Rect::_javaClass2(),Rect::_Init2());
    jobject _obArg2 = ((!arg2_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg2_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/graphics/$.uno(10937)
// ----------------------------------------------------------------------------------
...
// public int describeContents() :11304
void RectF__describeContents_fn(RectF* __this, int* __retval)
{
    *__retval = __this->describeContents();
}

// public static extern int describeContents_IMPL_7235(bool arg0, Android.Base.Primitives.ujobject arg1) :11417
...
// public override sealed bool equals(Android.java.lang.Object arg0) :11124
void RectF__equals1_fn(RectF* __this, ::g::Android::java::lang::Object* arg0, bool* __retval)
{
    uStackFrame __("Android.android.graphics.RectF", "equals(Android.java.lang.Object)");
    return *__retval = RectF::equals_IMPL_7205(__this->_subclassed, __this->_javaObject, (uObject*)arg0), void();
}

// public static extern bool equals_IMPL_7205(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2) :11327
...
{
    uStackFrame __("Android.android.graphics.RectF", "hashCode()");
...
{
    uStackFrame __("Android.android.graphics.RectF", "toString()");
...
// public void writeToParcel(Android.android.os.Parcel arg0, int arg1) :11310
void RectF__writeToParcel_fn(RectF* __this, ::g::Android::android::os::Parcel* arg0, int* arg1)
{
    __this->writeToParcel(arg0, *arg1);
}

// public static extern void writeToParcel_IMPL_7236(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2, int arg3) :11420
...
// public int describeContents() [instance] :11304
int RectF::describeContents()
{
    uStackFrame __("Android.android.graphics.RectF", "describeContents()");
    return RectF::describeContents_IMPL_7235(_subclassed, _javaObject);
}

// public void writeToParcel(Android.android.os.Parcel arg0, int arg1) [instance] :11310
void RectF::writeToParcel(::g::Android::android::os::Parcel* arg0, int arg1)
{
    uStackFrame __("Android.android.graphics.RectF", "writeToParcel(Android.android.os.Parcel,int)");
    int arg1_ = arg1;
...
void RectF::_Init2()
{
    uStackFrame __("Android.android.graphics.RectF", "_Init()");
...
// public static extern int describeContents_IMPL_7235(bool arg0, Android.Base.Primitives.ujobject arg1) [static] :11417
int RectF::describeContents_IMPL_7235(bool arg0_, jobject arg1_)
{
    uStackFrame __("Android.android.graphics.RectF", "describeContents_IMPL_7235(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
...
// public static extern bool equals_IMPL_7205(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2) [static] :11327
bool RectF::equals_IMPL_7205(bool arg0_, jobject arg1_, uObject* arg2_)
{
    uStackFrame __("Android.android.graphics.RectF", "equals_IMPL_7205(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
    CLASS_INIT(RectF::_javaClass2(),RectF::_Init2());
    jobject _obArg2 = ((!arg2_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg2_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
    bool result;
...
{
    uStackFrame __("Android.android.graphics.RectF", "hashCode_IMPL_7206(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
    CLASS_INIT(RectF::_javaClass2(),RectF::_Init2());
...
{
    uStackFrame __("Android.android.graphics.RectF", "toString_IMPL_7207(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
    CLASS_INIT(RectF::_javaClass2(),RectF::_Init2());
...
// public static extern void writeToParcel_IMPL_7236(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2, int arg3) [static] :11420
void RectF::writeToParcel_IMPL_7236(bool arg0_, jobject arg1_, uObject* arg2_, int arg3_)
{
    uStackFrame __("Android.android.graphics.RectF", "writeToParcel_IMPL_7236(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper,int)");
    INIT_JNI;
    CLASS_INIT(RectF::_javaClass2(),RectF::_Init2());
    jobject _obArg2 = ((!arg2_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg2_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/graphics/$.uno(11439)
// ----------------------------------------------------------------------------------

// public sealed extern class Region :11439
// {
...
// public static extern new void _Init() :11443
void Region___Init2_fn()
{
    Region::_Init2();
}

// public int describeContents() :11688
void Region__describeContents_fn(Region* __this, int* __retval)
{
    *__retval = __this->describeContents();
}

// public static extern int describeContents_IMPL_7278(bool arg0, Android.Base.Primitives.ujobject arg1) :11798
...
// public override sealed bool equals(Android.java.lang.Object arg0) :11700
void Region__equals1_fn(Region* __this, ::g::Android::java::lang::Object* arg0, bool* __retval)
{
    uStackFrame __("Android.android.graphics.Region", "equals(Android.java.lang.Object)");
    return *__retval = Region::equals_IMPL_7280(__this->_subclassed, __this->_javaObject, (uObject*)arg0), void();
}

// public static extern bool equals_IMPL_7280(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2) :11804
...
// public override sealed Android.java.lang.String toString() :11682
void Region__toString_fn(Region* __this, ::g::Android::java::lang::String** __retval)
{
    uStackFrame __("Android.android.graphics.Region", "toString()");
...
// public static extern Android.Base.Wrappers.IJWrapper toString_IMPL_7277(bool arg0, Android.Base.Primitives.ujobject arg1) :11795
...
// public void writeToParcel(Android.android.os.Parcel arg0, int arg1) :11694
void Region__writeToParcel_fn(Region* __this, ::g::Android::android::os::Parcel* arg0, int* arg1)
{
    __this->writeToParcel(arg0, *arg1);
}

// public static extern void writeToParcel_IMPL_7279(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2, int arg3) :11801
...
// public int describeContents() [instance] :11688
int Region::describeContents()
{
    uStackFrame __("Android.android.graphics.Region", "describeContents()");
    return Region::describeContents_IMPL_7278(_subclassed, _javaObject);
}

// public void writeToParcel(Android.android.os.Parcel arg0, int arg1) [instance] :11694
void Region::writeToParcel(::g::Android::android::os::Parcel* arg0, int arg1)
{
    uStackFrame __("Android.android.graphics.Region", "writeToParcel(Android.android.os.Parcel,int)");
    int arg1_ = arg1;
    Region::writeToParcel_IMPL_7279(_subclassed, _javaObject, (uObject*)arg0, arg1_);
}

// public static extern new void _Init() [static] :11443
void Region::_Init2()
{
    uStackFrame __("Android.android.graphics.Region", "_Init()");
...
// public static extern int describeContents_IMPL_7278(bool arg0, Android.Base.Primitives.ujobject arg1) [static] :11798
int Region::describeContents_IMPL_7278(bool arg0_, jobject arg1_)
{
    uStackFrame __("Android.android.graphics.Region", "describeContents_IMPL_7278(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
...
// public static extern bool equals_IMPL_7280(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2) [static] :11804
bool Region::equals_IMPL_7280(bool arg0_, jobject arg1_, uObject* arg2_)
{
    uStackFrame __("Android.android.graphics.Region", "equals_IMPL_7280(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
    CLASS_INIT(Region::_javaClass2(),Region::_Init2());
    jobject _obArg2 = ((!arg2_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg2_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
    bool result;
...
// public static extern Android.Base.Wrappers.IJWrapper toString_IMPL_7277(bool arg0, Android.Base.Primitives.ujobject arg1) [static] :11795
uObject* Region::toString_IMPL_7277(bool arg0_, jobject arg1_)
{
    uStackFrame __("Android.android.graphics.Region", "toString_IMPL_7277(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
    CLASS_INIT(Region::_javaClass2(),Region::_Init2());
...
// public static extern void writeToParcel_IMPL_7279(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2, int arg3) [static] :11801
void Region::writeToParcel_IMPL_7279(bool arg0_, jobject arg1_, uObject* arg2_, int arg3_)
{
    uStackFrame __("Android.android.graphics.Region", "writeToParcel_IMPL_7279(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper,int)");
    INIT_JNI;
    CLASS_INIT(Region::_javaClass2(),Region::_Init2());
    jobject _obArg2 = ((!arg2_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg2_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/graphics/$.uno(3472)
// ---------------------------------------------------------------------------------

// public extern class Shader :3472
// {
...
// public Shader(Android.Base.Primitives.ujobject obj, Uno.Type utype, bool hasFallbackClass, bool resolveType) :3477
void Shader__ctor_6_fn(Shader* __this, jobject* obj, uType* utype, bool* hasFallbackClass, bool* resolveType)
{
    __this->ctor_6(*obj, utype, *hasFallbackClass, *resolveType);
}

// public Shader(Android.Base.Primitives.ujobject obj, Uno.Type utype, bool hasFallbackClass, bool resolveType) [instance] :3477
void Shader::ctor_6(jobject obj, uType* utype, bool hasFallbackClass, bool resolveType)
{
    uStackFrame __("Android.android.graphics.Shader", ".ctor(Android.Base.Primitives.ujobject,Uno.Type,bool,bool)");
    ctor_4(obj, utype, hasFallbackClass, resolveType);
}
// }

// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/graphics/$.uno(1988)
// ---------------------------------------------------------------------------------

// public sealed extern class ShaderDLRTileMode :1988
// {
...
// public static extern new void _Init() :1992
void ShaderDLRTileMode___Init3_fn()
{
    ShaderDLRTileMode::_Init3();
}

// public static Android.android.graphics.ShaderDLRTileMode get_CLAMP() :1997
...
// public static extern new void _Init() [static] :1992
void ShaderDLRTileMode::_Init3()
{
    uStackFrame __("Android.android.graphics.ShaderDLRTileMode", "_Init()");
...
// public static Android.android.graphics.ShaderDLRTileMode get_CLAMP() [static] :1997
ShaderDLRTileMode* ShaderDLRTileMode::CLAMP()
{
    uStackFrame __("Android.android.graphics.ShaderDLRTileMode", "get_CLAMP()");
    INIT_JNI;
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/graphics/$.uno(11972)
// ----------------------------------------------------------------------------------
...
// public void getTransformMatrix(Android.Runtime.FloatArray arg0) :12045
...
// public static extern void getTransformMatrix_IMPL_7306(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2) :12090
...
{
    uStackFrame __("Android.android.graphics.SurfaceTexture", ".ctor(int)");
    ctor_4(::g::Android::Base::JNI::GetDefaultObject(), ::g::Android::Base::JNI::GetDefaultType(), false, false);
    INIT_JNI;;
...
// public void getTransformMatrix(Android.Runtime.FloatArray arg0) [instance] :12045
void SurfaceTexture::getTransformMatrix(::g::Android::Runtime::FloatArray* arg0)
{
    uStackFrame __("Android.android.graphics.SurfaceTexture", "getTransformMatrix(Android.Runtime.FloatArray)");
...
{
    uStackFrame __("Android.android.graphics.SurfaceTexture", "release()");
...
{
    uStackFrame __("Android.android.graphics.SurfaceTexture", "setOnFrameAvailableListener(Android.android.graphics.SurfaceTextureDLROnFrameAvailableListener)");
...
{
    uStackFrame __("Android.android.graphics.SurfaceTexture", "updateTexImage()");
...
{
    uStackFrame __("Android.android.graphics.SurfaceTexture", "_Init()");
...
// public static extern void getTransformMatrix_IMPL_7306(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2) [static] :12090
void SurfaceTexture::getTransformMatrix_IMPL_7306(bool arg0_, jobject arg1_, uObject* arg2_)
{
    uStackFrame __("Android.android.graphics.SurfaceTexture", "getTransformMatrix_IMPL_7306(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
    CLASS_INIT(SurfaceTexture::_javaClass2(),SurfaceTexture::_Init2());
    jobject _obArg2 = ((!arg2_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg2_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
...
{
    uStackFrame __("Android.android.graphics.SurfaceTexture", "release_IMPL_7308(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
    CLASS_INIT(SurfaceTexture::_javaClass2(),SurfaceTexture::_Init2());
...
{
    uStackFrame __("Android.android.graphics.SurfaceTexture", "setOnFrameAvailableListener_IMPL_7300(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
    CLASS_INIT(SurfaceTexture::_javaClass2(),SurfaceTexture::_Init2());
    jobject _obArg2 = ((!arg2_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg2_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
...
{
    uStackFrame __("Android.android.graphics.SurfaceTexture", "updateTexImage_IMPL_7302(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
    CLASS_INIT(SurfaceTexture::_javaClass2(),SurfaceTexture::_Init2());
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/graphics/$.uno(12544)
// ----------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/graphics/$.uno(12170)
// ----------------------------------------------------------------------------------
...
// public override sealed bool equals(Android.java.lang.Object arg0) :12390
void Typeface__equals1_fn(Typeface* __this, ::g::Android::java::lang::Object* arg0, bool* __retval)
{
    uStackFrame __("Android.android.graphics.Typeface", "equals(Android.java.lang.Object)");
    return *__retval = Typeface::equals_IMPL_7332(__this->_subclassed, __this->_javaObject, (uObject*)arg0), void();
}

// public static extern bool equals_IMPL_7332(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2) :12433
...
{
    uStackFrame __("Android.android.graphics.Typeface", "hashCode()");
...
{
    uStackFrame __("Android.android.graphics.Typeface", "_Init()");
...
{
    uStackFrame __("Android.android.graphics.Typeface", "createFromAsset(Android.android.content.res.AssetManager,Android.java.lang.String)");
...
{
    uStackFrame __("Android.android.graphics.Typeface", "createFromAsset_IMPL_7328(Android.Base.Wrappers.IJWrapper,Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
...
{
    uStackFrame __("Android.android.graphics.Typeface", "createFromFile(Android.java.lang.String)");
...
{
    uStackFrame __("Android.android.graphics.Typeface", "createFromFile_IMPL_7330(Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
    CLASS_INIT(Typeface::_javaClass2(),Typeface::_Init2());
    jobject _obArg0 = ((!arg0_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg0_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
    uObject* result;
...
// public static extern bool equals_IMPL_7332(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2) [static] :12433
bool Typeface::equals_IMPL_7332(bool arg0_, jobject arg1_, uObject* arg2_)
{
    uStackFrame __("Android.android.graphics.Typeface", "equals_IMPL_7332(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
    CLASS_INIT(Typeface::_javaClass2(),Typeface::_Init2());
    jobject _obArg2 = ((!arg2_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg2_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
    bool result;
...
{
    uStackFrame __("Android.android.graphics.Typeface", "hashCode_IMPL_7333(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
    CLASS_INIT(Typeface::_javaClass2(),Typeface::_Init2());
...
{
    uStackFrame __("Android.android.graphics.Typeface", "get_DEFAULT()");
    INIT_JNI;
    CLASS_INIT(Typeface::_javaClass2(),Typeface::_Init2());
