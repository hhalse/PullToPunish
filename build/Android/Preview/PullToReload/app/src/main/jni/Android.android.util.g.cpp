...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/util/$.uno(6223)
// -----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/util/$.uno(11)
// ---------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/util/$.uno(4112)
// -----------------------------------------------------------------------------

// public sealed extern class SparseArray :4112
// {
...
// public static extern new void _Init() :4116
void SparseArray___Init2_fn()
{
    SparseArray::_Init2();
}

// public override sealed Android.java.lang.String toString() :4245
void SparseArray__toString_fn(SparseArray* __this, ::g::Android::java::lang::String** __retval)
{
    uStackFrame __("Android.android.util.SparseArray", "toString()");
...
// public static extern Android.Base.Wrappers.IJWrapper toString_IMPL_20590(bool arg0, Android.Base.Primitives.ujobject arg1) :4302
...
// public static extern new void _Init() [static] :4116
void SparseArray::_Init2()
{
    uStackFrame __("Android.android.util.SparseArray", "_Init()");
...
// public static extern Android.Base.Wrappers.IJWrapper toString_IMPL_20590(bool arg0, Android.Base.Primitives.ujobject arg1) [static] :4302
uObject* SparseArray::toString_IMPL_20590(bool arg0_, jobject arg1_)
{
    uStackFrame __("Android.android.util.SparseArray", "toString_IMPL_20590(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/util/$.uno(5128)
// -----------------------------------------------------------------------------
...
{
    uStackFrame __("Android.android.util.TypedValue", "toString()");
...
{
    uStackFrame __("Android.android.util.TypedValue", "_Init()");
...
{
    uStackFrame __("Android.android.util.TypedValue", "toString_IMPL_20716(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
...
{
    uStackFrame __("Android.android.util.TypedValue", "get_COMPLEX_UNIT_DIP()");
    INIT_JNI;
    CLASS_INIT(TypedValue::_javaClass2(),TypedValue::_Init2());
