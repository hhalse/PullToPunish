...
// /usr/local/share/uno/Packages/Fuse.Camera/0.23.2/$.uno(373)
// -----------------------------------------------------------
...
{
    uStackFrame __("Fuse.Camera.AndroidCameraImpl", "IsAvailable()");
    return true;
}
...
{
    uStackFrame __("Fuse.Camera.AndroidCameraImpl", "TakePicture(Uno.Threading.Promise<Fuse.Camera.PictureResult>,Fuse.Camera.TakePictureOptions)");
    AndroidCameraImpl__DispatchTakePicture* d = AndroidCameraImpl__DispatchTakePicture::New1(futurePath, options);
    d->Fire();
}
// }

// /usr/local/share/uno/Packages/Fuse.Camera/0.23.2/$.uno(106)
// -----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Camera/0.23.2/$.uno(429)
// -----------------------------------------------------------
...
{
    uStackFrame __("Fuse.Camera.AndroidCameraImpl.DispatchTakePicture", ".ctor(Uno.Threading.Promise<Fuse.Camera.PictureResult>,Fuse.Camera.TakePictureOptions)");
...
{
    uStackFrame __("Fuse.Camera.AndroidCameraImpl.DispatchTakePicture", "Fire()");
...
// /usr/local/share/uno/Packages/Fuse.Camera/0.23.2/$.uno(95)
// ----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Camera/0.23.2/$.uno(50)
// ----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Camera/0.23.2/$.uno(14)
// ----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Camera/0.23.2/$.uno(388)
// -----------------------------------------------------------
...
{
    uStackFrame __("Fuse.Camera.AndroidCameraImpl.TakePictureTask", "OnFailed(Android.Base.Wrappers.IJWrapper)");
...
{
    uStackFrame __("Fuse.Camera.AndroidCameraImpl.TakePictureTask", "OnSuccess(Android.Base.Wrappers.IJWrapper)");
...
{
    uStackFrame __("Fuse.Camera.AndroidCameraImpl.TakePictureTask", ".ctor(Uno.Threading.Promise<Fuse.Camera.PictureResult>,Fuse.Camera.TakePictureOptions)");
...
{
    uStackFrame __("Fuse.Camera.AndroidCameraImpl.TakePictureTask", "fireResultCode()");
