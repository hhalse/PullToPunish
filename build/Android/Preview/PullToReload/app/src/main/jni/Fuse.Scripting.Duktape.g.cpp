...
// /usr/local/share/uno/Packages/Fuse.Scripting.Duktape/0.23.2/$.uno(550)
// ----------------------------------------------------------------------

// internal extern delegate int callback(Uno.IntPtr ctx) :550
...
// /usr/local/share/uno/Packages/Fuse.Scripting.Duktape/0.23.2/$.uno(90)
// ---------------------------------------------------------------------

// internal sealed extern class CallbackClosure :90
// {
...
// public CallbackClosure(Uno.IntPtr context, Fuse.Scripting.Callback callback) :95
void CallbackClosure__ctor__fn(CallbackClosure* __this, void** context, uDelegate* callback)
{
    __this->ctor_(*context, callback);
}

// public CallbackClosure New(Uno.IntPtr context, Fuse.Scripting.Callback callback) :95
...
// public object Proxy(object[] args) :101
void CallbackClosure__Proxy_fn(CallbackClosure* __this, uArray* args, uObject** __retval)
{
    *__retval = __this->Proxy(args);
}

// public CallbackClosure(Uno.IntPtr context, Fuse.Scripting.Callback callback) [instance] :95
...
// public object Proxy(object[] args) [instance] :101
...
// public CallbackClosure New(Uno.IntPtr context, Fuse.Scripting.Callback callback) [static] :95
...
// /usr/local/share/uno/Packages/Fuse.Scripting.Duktape/0.23.2/$.uno(553)
// ----------------------------------------------------------------------

// internal extern enum CompileFlag :553
...
// /usr/local/share/uno/Packages/Fuse.Scripting.Duktape/0.23.2/$.uno(117)
// ----------------------------------------------------------------------

// public sealed extern class Context :117
// {
// static Context() :117
...
// internal bool EnumeratorNext(int index, bool getValue) :523
...
// public object Evaluate(string code) :214
...
// public Context(Fuse.Scripting.IDispatcher dispatcher) [instance] :148
void Context::ctor_1(uObject* dispatcher)
{
    uStackFrame __("Fuse.Scripting.Duktape.Context", ".ctor(Fuse.Scripting.IDispatcher)");
    ctor_(dispatcher);
    _isAlive = true;
...
// internal int AddCallback(Fuse.Scripting.Callback callback) [instance] :157
...
// internal void CheckError(int errorCode) [instance] :419
...
// internal void Construct(int argc) [instance] :501
...
// internal bool DelProperty(int index, string key) [instance] :433
...
// internal bool EnumeratorNext(int index, bool getValue) [instance] :523
...
// public object Evaluate(string code) [instance] :214
...
// public void EvaluateNoResult(string code) [instance] :208
...
// internal bool GetBool(int index) [instance] :435
...
// internal Fuse.Scripting.ScriptException GetError(int index) [instance] :371
...
// internal Uno.IntPtr GetHeapPtr(int index) [instance] :487
...
// internal int GetInt(int index) [instance] :467
...
// internal long GetLength(int index) [instance] :489
...
// internal double GetNumber(int index) [instance] :465
...
// internal bool GetProperty(int index, int arrIndex) [instance] :437
...
// internal bool GetProperty(int index, string key) [instance] :439
...
// internal string GetString(int index) [instance] :491
...
// internal int GetTop() [instance] :469
int Context::GetTop()
{
...
// internal bool HasProperty(int index, string key) [instance] :463
...
// internal object IndexToObject(int index) [instance] :247
...
// private void InitCallbacks() [instance] :165
...
// internal bool IsArray(int index) [instance] :441
...
// internal bool IsBool(int index) [instance] :443
...
// internal bool IsFunction(int index) [instance] :445
...
// internal bool IsNullOrUndefined(int index) [instance] :451
...
// internal bool IsNumber(int index) [instance] :453
...
// internal bool IsObject(int index) [instance] :455
...
// internal bool IsString(int index) [instance] :457
...
// public Fuse.Scripting.Duktape.JSArray MakeArray() [instance] :232
...
// public Fuse.Scripting.Duktape.JSObject MakeObject() [instance] :223
...
// internal void Pop() [instance] :507
void Context::Pop()
{
...
// internal void Pop2() [instance] :509
void Context::Pop2()
{
...
// private void ProxyCallback(Uno.IntPtr ctx) [instance] :176
...
// internal void Push(bool val) [instance] :513
...
// internal void Push(double val) [instance] :515
...
// internal void Push(Fuse.Scripting.Callback callback) [instance] :364
...
// internal void Push(int val) [instance] :517
...
// internal void Push(object value) [instance] :281
...
// internal void Push(string str) [instance] :519
...
// internal int PushArray() [instance] :471
...
// internal void PushCallbackProxy(int argc) [instance] :525
...
// internal void PushDelegate(Uno.Action<Uno.IntPtr> del) [instance] :527
...
// internal void PushEnumerator(int index, Fuse.Scripting.Duktape.EnumFlags flags) [instance] :521
...
// internal void PushGlobalObject() [instance] :529
...
// internal void PushGlobalStash() [instance] :531
...
// internal int PushHeapPtr(Uno.IntPtr ptr) [instance] :473
...
// internal void PushNull() [instance] :533
...
// internal int PushObject() [instance] :475
...
// internal bool PutProperty(int index, int arrIndex) [instance] :459
...
// internal bool PutProperty(int index, string key) [instance] :461
...
// internal int SafeCall(int argc) [instance] :477
...
// internal int SafeCallMethod(int argc) [instance] :479
...
// internal int SafeCompile(Fuse.Scripting.Duktape.CompileFlag flags) [instance] :483
...
// internal int SafeCompileFunction(string source) [instance] :481
...
// internal int SafeEval(string code) [instance] :485
...
// internal string SafeToString(int index) [instance] :493
...
// internal string Stash(Uno.IntPtr heapPtr) [instance] :345
...
// public Context New(Fuse.Scripting.IDispatcher dispatcher) [static] :148
...
// /usr/local/share/uno/Packages/Fuse.Scripting.Duktape/0.23.2/$.uno(578)
// ----------------------------------------------------------------------

// internal static extern class duktape :578
// {
...
// internal static Uno.IntPtr create_heap_default() :812
void duktape__create_heap_default_fn(void** __retval)
{
    *__retval = duktape::create_heap_default();
}

// internal static bool del_prop_string(Uno.IntPtr ctx, int obj_index, string key) :749
...
// internal static bool get_prop_string(Uno.IntPtr ctx, int obj_index, string key) :884
...
// internal static string get_string(Uno.IntPtr ctx, int index) :974
void duktape__get_string_fn(void** ctx, int* index, uString** __retval)
{
    *__retval = duktape::get_string(*ctx, *index);
}

// internal static int get_top(Uno.IntPtr ctx) :827
void duktape__get_top_fn(void** ctx, int* __retval)
{
    *__retval = duktape::get_top(*ctx);
}

// internal static bool has_prop_string(Uno.IntPtr ctx, int index, string key) :1039
...
// internal static bool put_prop_string(Uno.IntPtr ctx, int obj_index, string key) :843
...
// internal static string safe_to_string(Uno.IntPtr ctx, int index) :979
void duktape__safe_to_string_fn(void** ctx, int* index, uString** __retval)
{
    *__retval = duktape::safe_to_string(*ctx, *index);
}

// internal static Uno.IntPtr create_heap_default() [static] :812
...
// internal static bool del_prop_string(Uno.IntPtr ctx, int obj_index, string key) [static] :749
...
// internal static void destroy_heap(Uno.IntPtr ctx) [static] :854
...
// internal static void enum_(Uno.IntPtr ctx, int index, Fuse.Scripting.Duktape.EnumFlags flags) [static] :594
...
// internal static void error(Uno.IntPtr ctx, string message) [static] :784
...
// internal static bool get_boolean(Uno.IntPtr ctx, int index) [static] :984
...
// internal static Uno.IntPtr get_heapptr(Uno.IntPtr ctx, int index) [static] :954
...
// internal static int get_int(Uno.IntPtr ctx, int index) [static] :1029
...
// internal static long get_length(Uno.IntPtr ctx, int index) [static] :969
...
// internal static double get_number(Uno.IntPtr ctx, int index) [static] :964
...
// internal static bool get_prop_index(Uno.IntPtr ctx, int index, int arr_index) [static] :994
...
// internal static bool get_prop_string(Uno.IntPtr ctx, int obj_index, string key) [static] :884
...
// internal static string get_string(Uno.IntPtr ctx, int index) [static] :974
...
// internal static int get_top(Uno.IntPtr ctx) [static] :827
...
// internal static bool has_prop_string(Uno.IntPtr ctx, int index, string key) [static] :1039
...
// internal static bool is_array(Uno.IntPtr ctx, int index) [static] :889
...
// internal static bool is_boolean(Uno.IntPtr ctx, int index) [static] :894
...
// internal static bool is_function(Uno.IntPtr ctx, int index) [static] :904
...
// internal static bool is_null_or_undefined(Uno.IntPtr ctx, int index) [static] :919
...
// internal static bool is_number(Uno.IntPtr ctx, int index) [static] :924
...
// internal static bool is_object(Uno.IntPtr ctx, int index) [static] :929
...
// internal static bool is_string(Uno.IntPtr ctx, int index) [static] :934
...
// internal static void new_(Uno.IntPtr ctx, int nargs) [static] :1044
...
// internal static bool next(Uno.IntPtr ctx, int index, bool getValue) [static] :599
...
// internal static int pcall(Uno.IntPtr ctx, int nargs) [static] :614
...
// internal static int pcall_method(Uno.IntPtr ctx, int nargs) [static] :624
...
// internal static int pcompile(Uno.IntPtr ctx, uint flags) [static] :698
...
// internal static int pcompile_string(Uno.IntPtr ctx, uint flags, string src) [static] :693
...
// internal static int peval_string(Uno.IntPtr ctx, string code) [static] :849
...
// internal static void pop(Uno.IntPtr ctx) [static] :822
...
// internal static void pop_2(Uno.IntPtr ctx) [static] :1004
...
// internal static int push_array(Uno.IntPtr ctx) [static] :1014
...
// internal static void push_boolean(Uno.IntPtr ctx, bool value) [static] :989
...
// internal static void push_callback_proxy(Uno.IntPtr ctx, int argc) [static] :1024
...
// internal static void push_delegate(Uno.IntPtr ctx, Uno.Action<Uno.IntPtr> del) [static] :1034
...
// internal static void push_global_object(Uno.IntPtr ctx) [static] :817
...
// internal static void push_global_stash(Uno.IntPtr ctx) [static] :1019
...
// internal static int push_heapptr(Uno.IntPtr ctx, Uno.IntPtr ptr) [static] :949
...
// internal static void push_int(Uno.IntPtr ctx, int val) [static] :874
...
// internal static void push_null(Uno.IntPtr ctx) [static] :959
...
// internal static void push_number(Uno.IntPtr ctx, double val) [static] :838
...
// internal static int push_object(Uno.IntPtr ctx) [static] :859
...
// internal static void push_string(Uno.IntPtr ctx, string str) [static] :879
...
// internal static bool put_prop_index(Uno.IntPtr ctx, int index, int arr_index) [static] :999
...
// internal static bool put_prop_string(Uno.IntPtr ctx, int obj_index, string key) [static] :843
...
// internal static string safe_to_string(Uno.IntPtr ctx, int index) [static] :979
...
// /usr/local/share/uno/Packages/Fuse.Scripting.Duktape/0.23.2/$.uno(565)
// ----------------------------------------------------------------------

// internal extern enum EnumFlags :565
...
// /usr/local/share/uno/Packages/Fuse.Scripting.Duktape/0.23.2/$.uno(10)
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.Duktape/0.23.2/$.uno(1062)
// -----------------------------------------------------------------------

// public sealed extern class JSFunction :1062
// {
...
// internal JSFunction(Fuse.Scripting.Duktape.Context ctx, Uno.IntPtr handle) :1070
void JSFunction__ctor_1_fn(JSFunction* __this, ::g::Fuse::Scripting::Duktape::Context* ctx, void** handle)
{
    __this->ctor_1(ctx, *handle);
}

// public override sealed object Call(object[] args) :1110
...
// public override sealed Fuse.Scripting.Object Construct(object[] args) :1096
...
// public override sealed bool Equals(Fuse.Scripting.Function a) :1083
...
// internal Uno.IntPtr get_Handle() :1064
void JSFunction__get_Handle_fn(JSFunction* __this, void** __retval)
{
    *__retval = __this->Handle();
}

// internal JSFunction New(Fuse.Scripting.Duktape.Context ctx, Uno.IntPtr handle) :1070
...
// internal JSFunction(Fuse.Scripting.Duktape.Context ctx, Uno.IntPtr handle) [instance] :1070
...
// internal Uno.IntPtr get_Handle() [instance] :1064
...
// internal JSFunction New(Fuse.Scripting.Duktape.Context ctx, Uno.IntPtr handle) [static] :1070
...
// /usr/local/share/uno/Packages/Fuse.Scripting.Duktape/0.23.2/$.uno(1194)
// -----------------------------------------------------------------------

// public sealed extern class JSObject :1194
// {
...
// public JSObject(Fuse.Scripting.Duktape.Context ctx, Uno.IntPtr handle) :1202
void JSObject__ctor_1_fn(JSObject* __this, ::g::Fuse::Scripting::Duktape::Context* ctx, void** handle)
{
    __this->ctor_1(ctx, *handle);
}

// public override sealed object CallMethod(string name, object[] args) :1296
...
// public override sealed bool ContainsKey(string key) :1315
...
// public override sealed bool Equals(Fuse.Scripting.Object obj) :1215
...
// public override sealed int GetHashCode() :1222
...
// internal Uno.IntPtr get_Handle() :1196
void JSObject__get_Handle_fn(JSObject* __this, void** __retval)
{
    *__retval = __this->Handle();
}

// public override sealed bool InstanceOf(Fuse.Scripting.Function type) :1227
...
// public override sealed object get_Item(string key) :1256
...
// public override sealed void set_Item(string key, object value) :1265
...
// public override sealed string[] get_Keys() :1276
...
// public JSObject New(Fuse.Scripting.Duktape.Context ctx, Uno.IntPtr handle) :1202
...
// public JSObject(Fuse.Scripting.Duktape.Context ctx, Uno.IntPtr handle) [instance] :1202
...
// internal Uno.IntPtr get_Handle() [instance] :1196
...
// public JSObject New(Fuse.Scripting.Duktape.Context ctx, Uno.IntPtr handle) [static] :1202
...
// /usr/local/share/uno/Packages/Fuse.Scripting.Duktape/0.23.2/$.uno(1141)
// -----------------------------------------------------------------------

// public static extern class JSONObject :1141
// {
...
// public static string Stringify(object value) :1143
void JSONObject__Stringify_fn(uObject* value, uString** __retval)
{
    *__retval = JSONObject::Stringify(value);
}

// public static string Stringify(object value) [static] :1143
