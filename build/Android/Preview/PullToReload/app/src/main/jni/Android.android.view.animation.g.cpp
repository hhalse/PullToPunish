...
#include <Android.Fallbacks.Android_android_view_animation_AnimationDLRAn-53fd3259.h>
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/view/animation/$.uno(11)
// -------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/view/animation/$.uno(3127)
// ---------------------------------------------------------------------------------------

// public abstract extern interface AnimationDLRAnimationListener :3127
// {
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/view/animation/$.uno(3148)
// ---------------------------------------------------------------------------------------

// public abstract extern interface Interpolator :3148
// {
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/view/animation/$.uno(1906)
// ---------------------------------------------------------------------------------------

// public sealed extern class LayoutAnimationController :1906
// {
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/view/animation/$.uno(2844)
// ---------------------------------------------------------------------------------------

// public sealed extern class Transformation :2844
// {
...
// public static extern new void _Init() :2848
void Transformation___Init2_fn()
{
    Transformation::_Init2();
}

// public override sealed Android.java.lang.String toString() :2982
void Transformation__toString_fn(Transformation* __this, ::g::Android::java::lang::String** __retval)
{
    uStackFrame __("Android.android.view.animation.Transformation", "toString()");
...
// public static extern Android.Base.Wrappers.IJWrapper toString_IMPL_21241(bool arg0, Android.Base.Primitives.ujobject arg1) :3020
...
// public static extern new void _Init() [static] :2848
void Transformation::_Init2()
{
    uStackFrame __("Android.android.view.animation.Transformation", "_Init()");
...
// public static extern Android.Base.Wrappers.IJWrapper toString_IMPL_21241(bool arg0, Android.Base.Primitives.ujobject arg1) [static] :3020
uObject* Transformation::toString_IMPL_21241(bool arg0_, jobject arg1_)
{
    uStackFrame __("Android.android.view.animation.Transformation", "toString_IMPL_21241(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
