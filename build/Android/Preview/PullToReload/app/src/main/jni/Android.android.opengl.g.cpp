...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/opengl/$.uno(28027)
// --------------------------------------------------------------------------------
...
void GLUtils::_Init2()
{
    uStackFrame __("Android.android.opengl.GLUtils", "_Init()");
...
{
    uStackFrame __("Android.android.opengl.GLUtils", "texImage2D(int,int,Android.android.graphics.Bitmap,int)");
...
{
    uStackFrame __("Android.android.opengl.GLUtils", "texImage2D_IMPL_13332(int,int,Android.Base.Wrappers.IJWrapper,int)");
    INIT_JNI;
