...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/net/$.uno(11)
// --------------------------------------------------------------------------
...
{
    uStackFrame __("Android.android.net.Uri", "equals(Android.java.lang.Object)");
...
{
    uStackFrame __("Android.android.net.Uri", "hashCode()");
...
void Uri::_Init2()
{
    uStackFrame __("Android.android.net.Uri", "_Init()");
...
{
    uStackFrame __("Android.android.net.Uri", "equals_IMPL_10991(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
...
{
    uStackFrame __("Android.android.net.Uri", "hashCode_IMPL_10992(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
    CLASS_INIT(Uri::_javaClass2(),Uri::_Init2());
...
{
    uStackFrame __("Android.android.net.Uri", "parse(Android.java.lang.String)");
...
{
    uStackFrame __("Android.android.net.Uri", "parse_IMPL_10996(Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
    CLASS_INIT(Uri::_javaClass2(),Uri::_Init2());
