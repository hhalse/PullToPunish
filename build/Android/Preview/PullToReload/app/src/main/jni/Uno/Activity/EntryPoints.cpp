...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    jclass activityClass = env->FindClass("com/PullToReload/PullToReload");
    jclass entryPointsClass = env->FindClass("com/PullToReload/ActivityNativeEntryPoints");
    jclass displayClass = env->FindClass("com/PullToReload/Display");
