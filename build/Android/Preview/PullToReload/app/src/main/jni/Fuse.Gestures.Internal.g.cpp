...
// /usr/local/share/uno/Packages/Fuse.Gestures/0.23.2/Internal/$.uno(277)
// ----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Gestures/0.23.2/Internal/$.uno(1247)
// -----------------------------------------------------------------------

// private sealed class TwoFinger.Point :1247
// {
...
// public generated Point New() [static] :1247
...
// /usr/local/share/uno/Packages/Fuse.Gestures/0.23.2/Internal/$.uno(826)
// ----------------------------------------------------------------------
        ...
        if (!_isHardCapture || _allowNewRegion)
        {
            ...
            if ((selRegion != NULL) && (selRegion != _pointerRegion))
            {
                ...
                if (!_isHardCapture)
                {
                    ...
                    ::g::Experimental::Physics::PointerVelocity__Reset1_fn(uPtr(_velocity), uCRef(_currentCoord), uCRef(::g::Uno::Float2__New1(0.0f)));
                    uPtr(_element)->BeginInteraction(this);
                }
...
// /usr/local/share/uno/Packages/Fuse.Gestures/0.23.2/Internal/$.uno(668)
// ----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Gestures/0.23.2/Internal/$.uno(662)
// ----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Gestures/0.23.2/Internal/$.uno(1176)
// -----------------------------------------------------------------------
...
// public generated void add_Started(Fuse.Gestures.Internal.TwoFingerEventHandler value) :1234
void TwoFinger__add_Started_fn(TwoFinger* __this, uDelegate* value)
{
    __this->add_Started(value);
}

// public generated void remove_Started(Fuse.Gestures.Internal.TwoFingerEventHandler value) :1234
...
// private TwoFinger(Fuse.Node n) [instance] :1186
...
// private void Begin() [instance] :1276
void TwoFinger::Begin()
{
    ...
    _begun = true;
    uPtr(_node)->BeginInteraction(this);
...
// public void Detach() [instance] :1210
...
// private float2 FromWindow(float2 p) [instance] :1296
...
// private void OnPointerMoved(object sender, Fuse.Input.PointerMovedArgs args) [instance] :1313
...
// private void OnPointerPressed(object sender, Fuse.Input.PointerPressedArgs args) [instance] :1255
...
// private void OnPointerReleased(object sender, Fuse.Input.PointerReleasedArgs args) [instance] :1385
...
// private void OnRooted() [instance] :1220
...
// private void OnUnrooted() [instance] :1227
...
// private Fuse.Gestures.Internal.TwoFinger.Point PointFromArgs(Fuse.Input.PointerEventArgs args) [instance] :1304
...
// public generated void add_Started(Fuse.Gestures.Internal.TwoFingerEventHandler value) [instance] :1234
...
// public generated void remove_Started(Fuse.Gestures.Internal.TwoFingerEventHandler value) [instance] :1234
...
// public static Fuse.Gestures.Internal.TwoFinger Attach(Fuse.Node n) [static] :1194
...
// private TwoFinger New(Fuse.Node n) [static] :1186
...
// /usr/local/share/uno/Packages/Fuse.Gestures/0.23.2/Internal/$.uno(1171)
// -----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Gestures/0.23.2/Internal/$.uno(1173)
// -----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Gestures/0.23.2/Internal/$.uno(1174)
// -----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Gestures/0.23.2/Internal/$.uno(1172)
// -----------------------------------------------------------------------
