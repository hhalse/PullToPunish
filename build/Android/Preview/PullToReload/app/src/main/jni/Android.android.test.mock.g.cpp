...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/test/mock/$.uno(320)
// ---------------------------------------------------------------------------------
...
{
    uStackFrame __("Android.android.test.mock.MockContext", "getResources()");
...
{
    uStackFrame __("Android.android.test.mock.MockContext", "getSystemService(Android.java.lang.String)");
...
{
    uStackFrame __("Android.android.test.mock.MockContext", "_Init()");
...
{
    uStackFrame __("Android.android.test.mock.MockContext", "getResources_IMPL_18557(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
...
{
    uStackFrame __("Android.android.test.mock.MockContext", "getSystemService_IMPL_18620(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
    CLASS_INIT(MockContext::_javaClass3(),MockContext::_Init3());
