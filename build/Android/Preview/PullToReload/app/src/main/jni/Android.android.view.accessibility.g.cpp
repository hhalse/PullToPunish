...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/view/accessibility/$.uno(601)
// ------------------------------------------------------------------------------------------

// public sealed extern class AccessibilityEvent :601
// {
...
// public static extern new void _Init() :605
void AccessibilityEvent___Init3_fn()
{
    AccessibilityEvent::_Init3();
}

// public int describeContents() :1245
void AccessibilityEvent__describeContents_fn(AccessibilityEvent* __this, int* __retval)
{
    *__retval = __this->describeContents();
}

// public static extern int describeContents_IMPL_20784(bool arg0, Android.Base.Primitives.ujobject arg1) :1327
...
// public override sealed Android.java.lang.String toString() :1251
void AccessibilityEvent__toString_fn(AccessibilityEvent* __this, ::g::Android::java::lang::String** __retval)
{
    uStackFrame __("Android.android.view.accessibility.AccessibilityEvent", "toString()");
...
// public static extern Android.Base.Wrappers.IJWrapper toString_IMPL_20785(bool arg0, Android.Base.Primitives.ujobject arg1) :1330
...
// public void writeToParcel(Android.android.os.Parcel arg0, int arg1) :1239
...
// public static extern void writeToParcel_IMPL_20783(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2, int arg3) :1324
...
// public int describeContents() [instance] :1245
int AccessibilityEvent::describeContents()
{
    uStackFrame __("Android.android.view.accessibility.AccessibilityEvent", "describeContents()");
    return AccessibilityEvent::describeContents_IMPL_20784(_subclassed, _javaObject);
}

// public void writeToParcel(Android.android.os.Parcel arg0, int arg1) [instance] :1239
void AccessibilityEvent::writeToParcel(::g::Android::android::os::Parcel* arg0, int arg1)
{
    uStackFrame __("Android.android.view.accessibility.AccessibilityEvent", "writeToParcel(Android.android.os.Parcel,int)");
    int arg1_ = arg1;
...
// public static extern void writeToParcel_IMPL_20783(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2, int arg3) [static] :1324
void AccessibilityEvent::writeToParcel_IMPL_20783(bool arg0_, jobject arg1_, uObject* arg2_, int arg3_)
{
    uStackFrame __("Android.android.view.accessibility.AccessibilityEvent", "writeToParcel_IMPL_20783(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper,int)");
    INIT_JNI;
    CLASS_INIT(AccessibilityEvent::_javaClass3(),AccessibilityEvent::_Init3());
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/view/accessibility/$.uno(1718)
// -------------------------------------------------------------------------------------------

// public sealed extern class AccessibilityNodeInfo :1718
// {
...
// public static extern new void _Init() :1722
void AccessibilityNodeInfo___Init2_fn()
{
    AccessibilityNodeInfo::_Init2();
}

// public int describeContents() :2838
void AccessibilityNodeInfo__describeContents_fn(AccessibilityNodeInfo* __this, int* __retval)
{
    *__retval = __this->describeContents();
}

// public static extern int describeContents_IMPL_20948(bool arg0, Android.Base.Primitives.ujobject arg1) :3166
...
// public override sealed bool equals(Android.java.lang.Object arg0) :2880
void AccessibilityNodeInfo__equals1_fn(AccessibilityNodeInfo* __this, ::g::Android::java::lang::Object* arg0, bool* __retval)
{
    uStackFrame __("Android.android.view.accessibility.AccessibilityNodeInfo", "equals(Android.java.lang.Object)");
    return *__retval = AccessibilityNodeInfo::equals_IMPL_20955(__this->_subclassed, __this->_javaObject, (uObject*)arg0), void();
}

// public static extern bool equals_IMPL_20955(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2) :3187
...
// public override sealed int hashCode() :2886
void AccessibilityNodeInfo__hashCode1_fn(AccessibilityNodeInfo* __this, int* __retval)
{
    uStackFrame __("Android.android.view.accessibility.AccessibilityNodeInfo", "hashCode()");
    return *__retval = AccessibilityNodeInfo::hashCode_IMPL_20956(__this->_subclassed, __this->_javaObject), void();
}

// public static extern int hashCode_IMPL_20956(bool arg0, Android.Base.Primitives.ujobject arg1) :3190
...
// public override sealed Android.java.lang.String toString() :2892
void AccessibilityNodeInfo__toString_fn(AccessibilityNodeInfo* __this, ::g::Android::java::lang::String** __retval)
{
    uStackFrame __("Android.android.view.accessibility.AccessibilityNodeInfo", "toString()");
...
// public static extern Android.Base.Wrappers.IJWrapper toString_IMPL_20957(bool arg0, Android.Base.Primitives.ujobject arg1) :3193
...
// public void writeToParcel(Android.android.os.Parcel arg0, int arg1) :2874
void AccessibilityNodeInfo__writeToParcel_fn(AccessibilityNodeInfo* __this, ::g::Android::android::os::Parcel* arg0, int* arg1)
{
    __this->writeToParcel(arg0, *arg1);
}

// public static extern void writeToParcel_IMPL_20954(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2, int arg3) :3184
...
// public int describeContents() [instance] :2838
int AccessibilityNodeInfo::describeContents()
{
    uStackFrame __("Android.android.view.accessibility.AccessibilityNodeInfo", "describeContents()");
    return AccessibilityNodeInfo::describeContents_IMPL_20948(_subclassed, _javaObject);
}

// public void writeToParcel(Android.android.os.Parcel arg0, int arg1) [instance] :2874
void AccessibilityNodeInfo::writeToParcel(::g::Android::android::os::Parcel* arg0, int arg1)
{
    uStackFrame __("Android.android.view.accessibility.AccessibilityNodeInfo", "writeToParcel(Android.android.os.Parcel,int)");
    int arg1_ = arg1;
    AccessibilityNodeInfo::writeToParcel_IMPL_20954(_subclassed, _javaObject, (uObject*)arg0, arg1_);
}

// public static extern new void _Init() [static] :1722
void AccessibilityNodeInfo::_Init2()
{
    uStackFrame __("Android.android.view.accessibility.AccessibilityNodeInfo", "_Init()");
...
// public static extern int describeContents_IMPL_20948(bool arg0, Android.Base.Primitives.ujobject arg1) [static] :3166
int AccessibilityNodeInfo::describeContents_IMPL_20948(bool arg0_, jobject arg1_)
{
    uStackFrame __("Android.android.view.accessibility.AccessibilityNodeInfo", "describeContents_IMPL_20948(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
...
// public static extern bool equals_IMPL_20955(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2) [static] :3187
bool AccessibilityNodeInfo::equals_IMPL_20955(bool arg0_, jobject arg1_, uObject* arg2_)
{
    uStackFrame __("Android.android.view.accessibility.AccessibilityNodeInfo", "equals_IMPL_20955(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
    CLASS_INIT(AccessibilityNodeInfo::_javaClass2(),AccessibilityNodeInfo::_Init2());
    jobject _obArg2 = ((!arg2_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg2_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
    bool result;
...
// public static extern int hashCode_IMPL_20956(bool arg0, Android.Base.Primitives.ujobject arg1) [static] :3190
int AccessibilityNodeInfo::hashCode_IMPL_20956(bool arg0_, jobject arg1_)
{
    uStackFrame __("Android.android.view.accessibility.AccessibilityNodeInfo", "hashCode_IMPL_20956(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
    CLASS_INIT(AccessibilityNodeInfo::_javaClass2(),AccessibilityNodeInfo::_Init2());
...
// public static extern Android.Base.Wrappers.IJWrapper toString_IMPL_20957(bool arg0, Android.Base.Primitives.ujobject arg1) [static] :3193
uObject* AccessibilityNodeInfo::toString_IMPL_20957(bool arg0_, jobject arg1_)
{
    uStackFrame __("Android.android.view.accessibility.AccessibilityNodeInfo", "toString_IMPL_20957(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
    CLASS_INIT(AccessibilityNodeInfo::_javaClass2(),AccessibilityNodeInfo::_Init2());
...
// public static extern void writeToParcel_IMPL_20954(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2, int arg3) [static] :3184
void AccessibilityNodeInfo::writeToParcel_IMPL_20954(bool arg0_, jobject arg1_, uObject* arg2_, int arg3_)
{
    uStackFrame __("Android.android.view.accessibility.AccessibilityNodeInfo", "writeToParcel_IMPL_20954(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper,int)");
    INIT_JNI;
    CLASS_INIT(AccessibilityNodeInfo::_javaClass2(),AccessibilityNodeInfo::_Init2());
    jobject _obArg2 = ((!arg2_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg2_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
...
// /usr/local/share/uno/Packages/Android/0.23.1/Android/android/view/accessibility/$.uno(11)
// -----------------------------------------------------------------------------------------
