...
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* BigCog_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* CogWheelReload_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* SmallCog_typeof();}
...
namespace g{namespace Uno{namespace UX{struct Property_type;}} ::g::Uno::UX::Property_type* PullToReload_FuseControlsTextControl_string_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property_type;}} ::g::Uno::UX::Property_type* PullToReload_FuseElementsElement_float_Height_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property_type;}} ::g::Uno::UX::Property_type* PullToReload_FuseElementsElement_float_MinHeight_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property_type;}} ::g::Uno::UX::Property_type* PullToReload_FuseRotation_float_Degrees_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property_type;}} ::g::Uno::UX::Property_type* PullToReload_FuseTranslation_float_Y_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property_type;}} ::g::Uno::UX::Property_type* PullToReload_FuseTriggersPullToReload_bool_IsLoading_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property_type;}} ::g::Uno::UX::Property_type* PullToReload_FuseTriggersWhileBool_bool_Value_Property_typeof();}
...
namespace g{namespace Uno{namespace UX{struct Template_type;}} ::g::Uno::UX::Template_type* CogWheelReload__Template_typeof();}
...
namespace g{uClassType* PullToReload_bundle_typeof();}
...
void uInitRtti()
{
    static uType*(*factories[])() =
    {
        ...
        (uType*(*)())&::g::CogWheelReload__Template_typeof,
        ...
        (uType*(*)())&::g::PullToReload_bundle_typeof,
        (uType*(*)())&::g::PullToReload_FuseControlsTextControl_string_Value_Property_typeof,
        (uType*(*)())&::g::PullToReload_FuseElementsElement_float_Height_Property_typeof,
        (uType*(*)())&::g::PullToReload_FuseElementsElement_float_MinHeight_Property_typeof,
        (uType*(*)())&::g::PullToReload_FuseRotation_float_Degrees_Property_typeof,
        (uType*(*)())&::g::PullToReload_FuseTranslation_float_Y_Property_typeof,
        (uType*(*)())&::g::PullToReload_FuseTriggersPullToReload_bool_IsLoading_Property_typeof,
        (uType*(*)())&::g::PullToReload_FuseTriggersWhileBool_bool_Value_Property_typeof,
