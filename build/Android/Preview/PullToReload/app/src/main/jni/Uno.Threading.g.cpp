...
// /usr/local/share/uno/Packages/Uno.Threading/0.23.4/$.uno(648)
// -------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/0.23.4/Tasks/$.uno(34)
// ------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/0.23.4/Tasks/$.uno(9)
// -----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/0.23.4/$.uno(155)
// -------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/0.23.4/$.uno(919)
// -------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/0.23.4/$.uno(779)
// -------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/0.23.4/$.uno(9)
// -----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/0.23.4/$.uno(17)
// ------------------------------------------------------------
...
::g::Uno::Threading::Future_type* Future1_typeof()
{
    ...
    ::TYPES[5] = ::g::Uno::Threading::Future_typeof();
    ::TYPES[6] = ::g::Uno::Collections::Queue_typeof()->MakeType(::g::Uno::Action1_typeof()->MakeType(::g::Uno::Exception_typeof()));
    ::TYPES[1] = ::g::Uno::Collections::Queue_typeof();
    ::TYPES[7] = ::g::Uno::Threading::Promise_typeof();
    ::TYPES[0] = ::g::Uno::Action1_typeof();
    ...
    ::TYPES[2] = ::g::Uno::Delegate_typeof();
    type->SetPrecalc(
        ::TYPES[1/*Uno.Collections.Queue`1*/]->MakeType(::TYPES[7/*Uno.Threading.Promise`1*/]->MakeType(type->T(0))),
        ::TYPES[7/*Uno.Threading.Promise`1*/]->MakeType(type->T(0)),
        ::TYPES[1/*Uno.Collections.Queue`1*/]->MakeType(::TYPES[0/*Uno.Action`1*/]->MakeType(type->T(0))),
        ::TYPES[0/*Uno.Action`1*/]->MakeType(type->T(0)),
        type->MakeMethod(1, ::TYPES[9/*Uno.Exception*/]),
...
void Future1__Invoke_fn(Future1* __this, uType* __type, uDelegate* action, void* arg)
{
    uType* __types[] = {
        __type->U(0),
        ::TYPES[10/*Uno.Threading.Future`1.Closure`1*/]->MakeType(__this->__type->GetBase(Future1_typeof())->T(0), __type->U(0)),
        __this->__type->GetBase(Future1_typeof())->T(0),
    };
    uStackFrame __("Uno.Threading.Future`1", "Invoke`1(Uno.Action<T1>,T1)");
    Future1__Closure* ret7;
    ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(__this->_dispatcher), ::TYPES[4/*Uno.Threading.IDispatcher*/]), uDelegate::New(::TYPES[3/*Uno.Action*/], (void*)Future1__Closure__Run_fn, (Future1__Closure__New1_fn(__types[1], action, arg, &ret7), ret7)));
}
...
// /usr/local/share/uno/Packages/Uno.Threading/0.23.4/$.uno(180)
// -------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/0.23.4/$.uno(195)
// -------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/0.23.4/Tasks/$.uno(206)
// -------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/0.23.4/$.uno(741)
// -------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/0.23.4/$.uno(695)
// -------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/0.23.4/$.uno(468)
// -------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/0.23.4/$.uno(795)
// -------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/0.23.4/Implementation/Cpp/$.uno(349)
// --------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/0.23.4/Implementation/Cpp/$.uno(386)
// --------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/0.23.4/Implementation/Cpp/$.uno(78)
// -------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/0.23.4/Implementation/Cpp/$.uno(262)
// --------------------------------------------------------------------------------
...
::g::Uno::Threading::Thread_type* POSIXThread_typeof()
{
    ...
    ::TYPES[14] = ::g::Uno::Threading::Thread_typeof();
    type->SetFields(1,
...
// public override sealed bool Join(int timeoutMillis) :312
...
// /usr/local/share/uno/Packages/Uno.Threading/0.23.4/$.uno(361)
// -------------------------------------------------------------
...
::g::Uno::Threading::Future_type* Promise_typeof()
{
    ...
    ::TYPES[15] = ::g::Uno::Threading::Future1_typeof();
    ::TYPES[16] = ::g::Uno::Threading::TaskFuture_typeof();
    type->SetPrecalc(
        ::TYPES[15/*Uno.Threading.Future`1*/]->MakeType(type->T(0)),
        ::TYPES[16/*Uno.Threading.TaskFuture`1*/]->MakeType(type->T(0)));
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Uno::Threading::Future_type, interface0));
    type->SetFields(8);
...
// /usr/local/share/uno/Packages/Uno.Threading/0.23.4/$.uno(342)
// -------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/0.23.4/Tasks/$.uno(65)
// ------------------------------------------------------------------
...
Task_type* Task_typeof()
{
    ...
    ::TYPES[17] = ::g::Uno::Exception_typeof()->Array();
    ::TYPES[2] = ::g::Uno::Delegate_typeof();
    ::TYPES[18] = ::g::Uno::Threading::TaskDelegate_typeof();
    ::TYPES[19] = ::g::Uno::Threading::CancellationTokenSource_typeof();
    ::TYPES[20] = ::g::Uno::Threading::ITaskScheduler_typeof();
    ::TYPES[21] = ::g::Uno::Threading::ThreadPoolTaskScheduler_typeof();
    type->SetInterfaces(
...
Task* Task::Run1(uDelegate* taskDelegate, uObject* scheduler)
{
    ...
    ::g::Uno::Threading::ITaskScheduler::ScheduleTask(uInterface(uPtr(scheduler), ::TYPES[20/*Uno.Threading.ITaskScheduler*/]), task);
    return task;
}
// }

// /usr/local/share/uno/Packages/Uno.Threading/0.23.4/Tasks/$.uno(61)
// ------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/0.23.4/$.uno(406)
// -------------------------------------------------------------
...
::g::Uno::Threading::Future_type* TaskFuture_typeof()
{
    ...
    ::STRINGS[6] = uString::Const("/usr/local/share/uno/Packages/Uno.Threading/0.23.4/$.uno");
    ::TYPES[18] = ::g::Uno::Threading::TaskDelegate_typeof();
    ::TYPES[22] = ::g::Uno::Threading::Task_typeof();
    ::TYPES[2] = ::g::Uno::Delegate_typeof();
    ::TYPES[23] = ::g::Uno::Func_typeof();
    type->SetPrecalc(
        ::TYPES[23/*Uno.Func`1*/]->MakeType(type->T(0)));
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Uno::Threading::Future_type, interface0));
    type->SetFields(8,
...
// /usr/local/share/uno/Packages/Uno.Threading/0.23.4/Tasks/$.uno(52)
// ------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/0.23.4/$.uno(510)
// -------------------------------------------------------------
...
Thread_type* Thread_typeof()
{
    ...
    ::STRINGS[0] = uString::Const("Feature not supported in this backend");
    ::TYPES[24] = ::g::Uno::Threading::POSIXThread_typeof();
    type->SetFields(0,
...
// /usr/local/share/uno/Packages/Uno.Threading/0.23.4/$.uno(771)
// -------------------------------------------------------------
...
ThreadPool_type* ThreadPool_typeof()
{
    ...
    ::TYPES[25] = ::g::Uno::Threading::ConcurrentQueue_typeof()->MakeType(ThreadPool__WorkItem_typeof());
    ::TYPES[26] = ::g::Uno::Threading::ConcurrentQueue_typeof()->MakeType(::g::Uno::Threading::Thread_typeof());
    ::TYPES[3] = ::g::Uno::Action_typeof();
    ::TYPES[27] = ::g::Uno::Bool_typeof();
...
void ThreadPool::ctor_(int poolSize)
{
    ...
    _taskQueue = ((::g::Uno::Threading::ConcurrentQueue*)::g::Uno::Threading::ConcurrentQueue::New1(::TYPES[25/*Uno.Threading.ConcurrentQueue<Uno.Threading.ThreadPool.WorkItem>*/]));
    _running = true;
    _disposeQueue = ((::g::Uno::Threading::ConcurrentQueue*)::g::Uno::Threading::ConcurrentQueue::New1(::TYPES[26/*Uno.Threading.ConcurrentQueue<Uno.Threading.Thread>*/]));
    _poolSize = poolSize;

    for (int i = 0; i < _poolSize; i++)
    {
        ::g::Uno::Threading::Thread* t = ::g::Uno::Threading::Thread::Create(uDelegate::New(::TYPES[3/*Uno.Action*/], (void*)ThreadPool__WorkerEntrypoint_fn, this));
        uPtr(t)->Start();
    }
}
...
// /usr/local/share/uno/Packages/Uno.Threading/0.23.4/Tasks/$.uno(211)
// -------------------------------------------------------------------
...
{
    uPtr(uPtr(::g::Uno::Application::Current())->Window())->add_Closed(uDelegate::New(::TYPES[31/*Uno.EventHandler*/], (void*)ThreadPoolTaskScheduler__OnWindowClosed_fn));
}
...
ThreadPoolTaskScheduler_type* ThreadPoolTaskScheduler_typeof()
{
    ...
    ::TYPES[29] = ::g::Uno::Platform::Window_typeof();
    ::TYPES[30] = ::g::Uno::Application_typeof();
...
void ThreadPoolTaskScheduler::ScheduleTask(::g::Uno::Threading::Task* task)
{
    ...
    uPtr(_threadPool)->QueueAction(uDelegate::New(::TYPES[3/*Uno.Action*/], (void*)::g::Uno::Threading::Task__Execute_fn, uPtr(task)));
}
...
// /usr/local/share/uno/Packages/Uno.Threading/0.23.4/$.uno(774)
// -------------------------------------------------------------
