...
// /usr/local/share/uno/Packages/Fuse.Camera/0.23.2/AndroidImpl/$.uno(9)
// ---------------------------------------------------------------------
...
// public Camera() :21
void Camera__ctor_3_fn(Camera* __this)
{
    __this->ctor_3();
}

// public Camera(Android.Base.Primitives.ujobject obj, Uno.Type utype, bool hasFallbackClass, bool resolveType) :20
void Camera__ctor_4_fn(Camera* __this, jobject* obj, uType* utype, bool* hasFallbackClass, bool* resolveType)
{
...
void Camera::ctor_3()
{
    uStackFrame __("Android.com.fuse.Native.Camera", ".ctor()");
...
void Camera::ctor_4(jobject obj, uType* utype, bool hasFallbackClass, bool resolveType)
{
    uStackFrame __("Android.com.fuse.Native.Camera", ".ctor(Android.Base.Primitives.ujobject,Uno.Type,bool,bool)");
...
void Camera::_Init1()
{
    uStackFrame __("Android.com.fuse.Native.Camera", "_Init()");
...
{
    uStackFrame __("Android.com.fuse.Native.Camera", "_InitProxy()");
...
{
    uStackFrame __("Android.com.fuse.Native.Camera", "_IsThisType(Android.Base.Wrappers.IJWrapper)");
    int N = 29;
...
{
    uStackFrame __("Android.com.fuse.Native.Camera", "Camera_IMPL_44276(Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
...
{
    uStackFrame __("Android.com.fuse.Native.Camera", "IntentCallback(int,int,Android.Base.Wrappers.IJWrapper)");
...
{
    uStackFrame __("Android.com.fuse.Native.Camera", "IntentCallback_IMPL_44278(int,int,Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
...
{
    uStackFrame __("Android.com.fuse.Native.Camera", "TakePicture(Android.Base.Wrappers.IJWrapper)");
...
{
    uStackFrame __("Android.com.fuse.Native.Camera", "TakePicture_IMPL_44277(Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
...
// /usr/local/share/uno/Packages/Fuse.Camera/0.23.2/AndroidImpl/$.uno(62)
// ----------------------------------------------------------------------
...
{
    uStackFrame __("Android.com.fuse.Native.CameraTask", ".ctor(int,int,bool)");
    ctor_1(::g::Android::Base::JNI::GetDefaultObject(), ::g::Android::Base::JNI::GetDefaultType(), false, false);
...
{
    uStackFrame __("Android.com.fuse.Native.CameraTask", "_Init()");
...
{
    uStackFrame __("Android.com.fuse.Native.CameraTask", "_InitProxy()");
...
{
    uStackFrame __("Android.com.fuse.Native.CameraTask", "_IsThisType(Android.Base.Wrappers.IJWrapper)");
    int N = 33;
...
{
    uStackFrame __("Android.com.fuse.Native.CameraTask", "CameraTask_IMPL_44283(Android.Base.Wrappers.IJWrapper,int,int,bool)");
    INIT_JNI;
