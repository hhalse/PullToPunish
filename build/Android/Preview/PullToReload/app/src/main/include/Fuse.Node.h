// This file was generated based on '/usr/local/share/uno/Packages/FuseCore/0.23.2/$.uno'.
...
struct Node : uObject
{
    ...
    bool _ignoreStyle;
    uStrong< ::g::Uno::Collections::HashSet*> _interactions;
    bool _isAddedUpdate;
    ...
    void BeginInteraction(uObject* what);
    ...
    void EndInteraction(uObject* what);
