...
struct Object : ::g::Fuse::Scripting::V8::Simple::Value
{
    ...
    ::g::Fuse::Scripting::V8::Simple::Value* CallMethod(uString* name, ::g::Fuse::Scripting::V8::Simple::ValueVector* args);
    bool ContainsKey(uString* key);
    bool Equals2(Object* arg);
    ::g::Fuse::Scripting::V8::Simple::Value* Get(uString* key);
    bool InstanceOf(::g::Fuse::Scripting::V8::Simple::Function* type);
    ::g::Fuse::Scripting::V8::Simple::UniqueValueVector* Keys();
    void Set(uString* key, ::g::Fuse::Scripting::V8::Simple::Value* value);
