...
struct FuseBasicTheme_FuseControlsTextEdit_float4_PlaceholderColor_Property : ::g::Uno::UX::Property
{
    uStrong< ::g::Fuse::Controls::TextEdit*> _obj;

    void ctor_1(::g::Fuse::Controls::TextEdit* obj);
    static FuseBasicTheme_FuseControlsTextEdit_float4_PlaceholderColor_Property* New1(::g::Fuse::Controls::TextEdit* obj);
};
// }
